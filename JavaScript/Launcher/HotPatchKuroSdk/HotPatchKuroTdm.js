...
const HotPatchKuroSdk_1 = require("./HotPatchKuroSdk");
const GLOBALROUTORADDRESS = "https://sg.tdatamaster.com:8013/tdm/v1/route";
const ROUTORADDRESS = "https://hc.tdm.qq.com:8013/tdm/v2/route";
    ...
    if (this.IfCanUseTdm()) {
      if (UE.KuroLauncherLibrary.IsFirstIntoLauncher()) {
        ...
        var t =
          ...
          BaseConfigController_1.BaseConfigController.GetPublicValue("TDMUrl"));
        var r =
          (t !== "Default" &&

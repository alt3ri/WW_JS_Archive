...
该类型的实体是怪物。`,
  ...
  GroupAi: {
    ...
    Components: ["BaseInfoComponent", "ModelComponent", "GroupAiComponent"],
  },
  FollowShooter: {
    Category: "辅助机类",
    Owner: "庄伟",
...
该类型的实体为样条实体，用于设置实体的运动路线，详情点击跳转👉https://kurogame.feishu.cn/wiki/BgTKwTqigi2hTNkTFvecP0IrnIc。`,
  ...
  SplineWall: {
    ...
    Owner: "未知",
    Status: "开发中",
    Description: "样条空气墙生成器，根据样条生成空气墙",
    EntityLogic: "ClientOnly",
    EntityType: "空气墙生成器(AirWallSpawner)",
    Components: ["BaseInfoComponent", "AirWallSpawnerComponent"],
  },
  MoveableTrigger: {
    Category: "触发器类",
    Owner: "蒋临风 ",
...
该类型的实体用于实现在场景GamePlay中控制子弹的发射与销毁，从而实现场景机制的击飞、造成伤害等效果。详情点击跳转👉https://kurogame.feishu.cn/wiki/TdgZwLMJHiNeQQkZ3pYcVqCGnhc 。`,
  ...
  SceneBulletCanHit: {
    ...
    EntityType: "可击中的场景子弹(SceneBulletCanHit)",
    EntityLogic: "Item",
    Components: [
      "BaseInfoComponent",
      "ModelComponent",
...
该类型的实体可使用探索技能进行交互，详情点击跳转👉https://kurogame.feishu.cn/wiki/FqEKwqThziWMtrkidXcclEqMnbh。`,
  ...
  AirPassage: {
    ...
    Components: ["BaseInfoComponent", "ModelComponent", "SplineComponent"],
  },
  Monitor: {
    Category: "机关玩法类",
    Owner: "韩志文 ",
  ...
  (exports.componentsByEntityUe5 = Object.fromEntries(
    Object.entries(exports.entityDetailsUe5).map(([t, n]) => [t, n.Components]),
  )),
  (exports.componentsByEntityAki = Object.fromEntries(
    Object.entries(exports.entityDetailsAki).map(([t, n]) => [t, n.Components]),
  )),
...
const collectRewardEntityTypes = ["Collect", "Animal", "CombatAnimal"];

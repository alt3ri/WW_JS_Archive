...
class ActorSystem {
    ...
    if (ActorSystem.Enable && 1 === ActorSystem.State) {
      ...
      if (ActorPoolGuard_1.ActorPoolGuard.CleanActorBeforeEnPool(e, t)) {
        ...
        if (t) {
          ...
          (t = new Entry(r, ActorSystem.C6.get(r) ?? 0)).Values.add(e),
            t.Touch(),
            ActorSystem.mp.Push(t),
            ActorSystem.ve.set(r, t);
        for (
          Info_1.Info.IsBuildDevelopmentOrDebug &&
            ActorSystemDebugger_1.ActorSystemDebugger.RecordGetPut({
              ClassName: r.GetName(),
            ...
            ActorSystem.n6 += 1;
          ActorSystem.n6 > ActorSystem.s6 ||
          ActorSystem.mp.Size > ActorSystem.s6;
  ...
  static SetBudget(t, e) {
    ...
    ActorSystem.m6(ActorSystem.S6, t, "ActorSystem.SetBudget.");
    if (e < 0)
      return (
        Log_1.Log.CheckError() &&
  ...
  static g6(t, e, r) {
    ...
    return UE.KuroActorManager.SpawnActor(
      Info_1.Info.World,
      t,
      e,
      1,

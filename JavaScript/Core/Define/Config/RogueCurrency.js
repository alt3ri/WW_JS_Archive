...
class RogueCurrency {
  ...
  static getRootAsRogueCurrency(t, i) {
    return (i || new RogueCurrency()).__init(
...
exports.RogueCurrency = RogueCurrency;
//# sourceMappingURL=RogueCurrency.js.map

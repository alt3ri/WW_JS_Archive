...
class RogueResAffix {
  ...
  static getRootAsRogueResAffix(t, i) {
    return (i || new RogueResAffix()).__init(
...
exports.RogueResAffix = RogueResAffix;
//# sourceMappingURL=RogueResAffix.js.map

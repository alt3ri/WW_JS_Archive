...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "t.图鉴系统.xlsx",
  TABLE = "GeographyType",
  COMMAND = "select BinData from `GeographyType`",
  KEY_PREFIX = "GeographyTypeAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGeographyTypeAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configGeographyTypeAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        e = GeographyType_1.GeographyType.getRootAsGeographyType(

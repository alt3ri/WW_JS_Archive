...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  MonsterHandBookType_1 = require("../Config/MonsterHandBookType"),
  DB = "db_handbook.db",
  FILE = "t.图鉴系统.xlsx",
  TABLE = "MonsterHandBookType",
  COMMAND = "select BinData from `MonsterHandBookType`",
  KEY_PREFIX = "MonsterHandBookTypeAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMonsterHandBookTypeAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configMonsterHandBookTypeAll.GetConfigList",
  );

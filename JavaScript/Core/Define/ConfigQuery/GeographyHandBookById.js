...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `GeographyHandBook` where Id=?",
  KEY_PREFIX = "GeographyHandBookById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configGeographyHandBookById.Init"),
  getConfigStat = Stats_1.Stat.Create("configGeographyHandBookById.GetConfig"),
  CONFIG_STAT_PREFIX = "configGeographyHandBookById.GetConfig(";

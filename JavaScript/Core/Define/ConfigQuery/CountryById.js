...
const TABLE = "Country";
const COMMAND = "select BinData from `Country` where Id=?";
const KEY_PREFIX = "CountryById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configCountryById.GetConfig(";
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          const r = Country_1.Country.getRootAsCountry(

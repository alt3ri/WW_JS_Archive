...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configMainLineAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "z.追月节.xlsx",
  TABLE = "MainLine",
  COMMAND = "select BinData from `MainLine`",
  KEY_PREFIX = "MainLineAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMainLineAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configMainLineAll.GetConfigList",
  );
  ...
  GetConfigList: (n = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = MainLine_1.MainLine.getRootAsMainLine(

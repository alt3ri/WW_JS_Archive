...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configSetAccountById.Init"),
  getConfigStat = Stats_1.Stat.Create("configSetAccountById.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const C = SetAccount_1.SetAccount.getRootAsSetAccount(

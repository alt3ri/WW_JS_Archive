...
const TimeOfDay_1 = require("../Config/TimeOfDay");
const DB = "db_time_of_day.db";
const FILE = "s.时间系统.xlsx";
const TABLE = "TimeOfDay";
const COMMAND = "select BinData from `TimeOfDay` where Id = ?";
const KEY_PREFIX = "TimeOfDayById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configTimeOfDayById.GetConfig(";

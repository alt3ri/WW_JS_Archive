...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configGameplayCueById.Init"),
  getConfigStat = Stats_1.Stat.Create("configGameplayCueById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const C = GameplayCue_1.GameplayCue.getRootAsGameplayCue(

...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configShieldById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configShieldById.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const C = Shield_1.Shield.getRootAsShield(

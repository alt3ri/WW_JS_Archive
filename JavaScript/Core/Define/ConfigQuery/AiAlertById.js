...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configAiAlertById.Init"),
  getConfigStat = Stats_1.Stat.Create("configAiAlertById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const C = AiAlert_1.AiAlert.getRootAsAiAlert(

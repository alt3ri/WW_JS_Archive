...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMultiMapAreaConfigAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configMultiMapAreaConfigAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = MultiMapAreaConfig_1.MultiMapAreaConfig.getRootAsMultiMapAreaConfig(

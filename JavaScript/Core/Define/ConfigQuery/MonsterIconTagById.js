...
const MonsterIconTag_1 = require("../Config/MonsterIconTag");
const DB = "db_component_config.db";
const FILE = "t.通用组件配置.xlsx";
const TABLE = "MonsterIconTag";
const COMMAND = "select BinData from `MonsterIconTag` where Id=?";
const KEY_PREFIX = "MonsterIconTagById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configMonsterIconTagById.GetConfig(";

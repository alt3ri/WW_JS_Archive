...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configRiskHarvestBuffGroupByActivityId = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RiskHarvestBuffGroup` where ActivityId = ?",
  KEY_PREFIX = "RiskHarvestBuffGroupByActivityId",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRiskHarvestBuffGroupByActivityId.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRiskHarvestBuffGroupByActivityId.GetConfigList",
  ),

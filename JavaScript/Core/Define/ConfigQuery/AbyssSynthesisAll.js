...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configAbyssSynthesisAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `AbyssSynthesis`",
  KEY_PREFIX = "AbyssSynthesisAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configAbyssSynthesisAll.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configAbyssSynthesisAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = AbyssSynthesis_1.AbyssSynthesis.getRootAsAbyssSynthesis(

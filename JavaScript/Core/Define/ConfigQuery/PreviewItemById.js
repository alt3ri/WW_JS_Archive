...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configPreviewItemById.Init"),
  getConfigStat = Stats_1.Stat.Create("configPreviewItemById.GetConfig"),
    ...
    if (n) {
      ...
      if (
        ...
        if (
          ...
          const C = PreviewItem_1.PreviewItem.getRootAsPreviewItem(

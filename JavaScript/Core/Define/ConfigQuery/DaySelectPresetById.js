...
const COMMAND = "select BinData from `DaySelectPreset` where Id=?";
const KEY_PREFIX = "DaySelectPresetById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configDaySelectPresetById.GetConfig(";

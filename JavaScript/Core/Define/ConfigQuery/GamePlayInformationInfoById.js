...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configGamePlayInformationInfoById = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  GamePlayInformationInfo_1 = require("../Config/GamePlayInformationInfo"),
  DB = "db_levelgameplay.db",
  FILE = "g.关卡玩法数据.xlsx",
  TABLE = "GamePlayInformationInfo",
  COMMAND = "select BinData from `GamePlayInformationInfo` where Id=?",
  KEY_PREFIX = "GamePlayInformationInfoById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configGamePlayInformationInfoById.Init",
  ),

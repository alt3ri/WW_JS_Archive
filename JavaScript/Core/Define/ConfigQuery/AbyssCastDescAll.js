...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configAbyssCastDescAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "s.深渊爬塔.xlsx",
  TABLE = "AbyssCastDesc",
  COMMAND = "select BinData from `AbyssCastDesc`",
  KEY_PREFIX = "AbyssCastDescAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssCastDescAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configAbyssCastDescAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = AbyssCastDesc_1.AbyssCastDesc.getRootAsAbyssCastDesc(

...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  ProtocolMonitoring_1 = require("../Config/ProtocolMonitoring"),
  DB = "db_protocol_monitor.db",
  FILE = "x.协议监听.xlsx",
  TABLE = "ProtocolMonitoring",
  COMMAND = "select BinData from `ProtocolMonitoring`",
  KEY_PREFIX = "ProtocolMonitoringByAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],

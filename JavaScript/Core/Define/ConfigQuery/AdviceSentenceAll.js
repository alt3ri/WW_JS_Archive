...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `AdviceSentence`",
  KEY_PREFIX = "AdviceSentenceAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configAdviceSentenceAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configAdviceSentenceAll.GetConfigList",
  );
  ...
  GetConfigList: (n = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = AdviceSentence_1.AdviceSentence.getRootAsAdviceSentence(

...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrialRoleInfoAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configTrialRoleInfoAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = TrialRoleInfo_1.TrialRoleInfo.getRootAsTrialRoleInfo(

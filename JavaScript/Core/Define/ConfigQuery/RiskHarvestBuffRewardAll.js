...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configRiskHarvestBuffRewardAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RiskHarvestBuffReward`",
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configRiskHarvestBuffRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configRiskHarvestBuffRewardAll.GetConfigList",
  );
exports.configRiskHarvestBuffRewardAll = {
  Init: () => {
    initStat.Start(),

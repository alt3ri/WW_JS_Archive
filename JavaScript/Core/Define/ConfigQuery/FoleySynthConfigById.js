...
const COMMAND = "select BinData from `FoleySynthConfig` where Id=?";
const KEY_PREFIX = "FoleySynthConfigById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configFoleySynthConfigById.GetConfig(";

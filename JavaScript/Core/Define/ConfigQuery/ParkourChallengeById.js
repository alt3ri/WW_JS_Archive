...
const COMMAND = "select BinData from `ParkourChallenge` where Id=?";
const KEY_PREFIX = "ParkourChallengeById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configParkourChallengeById.GetConfig(";

...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `MonsterHandBook`",
  KEY_PREFIX = "MonsterHandBookAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMonsterHandBookAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configMonsterHandBookAll.GetConfigList",
  );

...
const COMMAND = "select BinData from `DungeonDetection` where Id=?";
const KEY_PREFIX = "DungeonDetectionById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configDungeonDetectionById.GetConfig(";

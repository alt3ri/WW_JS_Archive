...
const COMMAND = "select BinData from `MapMarkRelativeSubType` where Id=?";
const KEY_PREFIX = "MapMarkRelativeSubTypeById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configMapMarkRelativeSubTypeById.GetConfig(";

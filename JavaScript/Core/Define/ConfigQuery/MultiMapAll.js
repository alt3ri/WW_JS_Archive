...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMultiMapAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configMultiMapAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        n = MultiMap_1.MultiMap.getRootAsMultiMap(

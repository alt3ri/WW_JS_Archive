...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configFavorLevelByLevel.Init"),
  getConfigStat = Stats_1.Stat.Create("configFavorLevelByLevel.GetConfig"),
    ...
    if (i) {
      ...
      if (
        ...
        if (
          ...
          const a = FavorLevel_1.FavorLevel.getRootAsFavorLevel(

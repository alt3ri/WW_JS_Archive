...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "s.输入配置.xlsx",
  TABLE = "ActionMapping",
  COMMAND = "select BinData from `ActionMapping`",
  KEY_PREFIX = "ActionMappingAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActionMappingAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configActionMappingAll.GetConfigList",
  );

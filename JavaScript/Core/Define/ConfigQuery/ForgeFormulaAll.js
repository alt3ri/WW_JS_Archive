...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "d.锻造.xlsx",
  TABLE = "ForgeFormula",
  COMMAND = "select BinData from `ForgeFormula`",
  KEY_PREFIX = "ForgeFormulaAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configForgeFormulaAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configForgeFormulaAll.GetConfigList",
  );

...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "c.充值.xlsx",
  TABLE = "PayItem",
  COMMAND = "select BinData from `PayItem`",
  KEY_PREFIX = "PayItemAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configPayItemAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configPayItemAll.GetConfigList");

...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGachaById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGachaById.GetConfig"),
  CONFIG_STAT_PREFIX = "configGachaById.GetConfig(",
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configGachaById.GetConfigList",
  ),

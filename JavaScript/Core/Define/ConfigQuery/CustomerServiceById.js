...
const COMMAND = "select BinData from `CustomerService` where Id=?";
const KEY_PREFIX = "CustomerServiceById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configCustomerServiceById.GetConfig(";

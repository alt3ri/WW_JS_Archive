...
const TABLE = "LordGym";
const COMMAND = "select BinData from `LordGym` where Id=?";
const KEY_PREFIX = "LordGymById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configLordGymById.GetConfig(";
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          const r = LordGym_1.LordGym.getRootAsLordGym(

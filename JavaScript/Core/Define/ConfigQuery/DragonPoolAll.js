...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configDragonPoolAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configDragonPoolAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = DragonPool_1.DragonPool.getRootAsDragonPool(

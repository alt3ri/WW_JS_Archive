...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMultiMapById.Init"),
  getConfigStat = Stats_1.Stat.Create("configMultiMapById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const a = MultiMap_1.MultiMap.getRootAsMultiMap(

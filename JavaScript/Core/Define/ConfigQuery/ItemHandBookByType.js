...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configItemHandBookByType.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configItemHandBookByType.GetConfigList",
  ),
    ...
    if (i) {
      ...
      if (
        ...
        for (;;) {
          ...
          a = ItemHandBook_1.ItemHandBook.getRootAsItemHandBook(

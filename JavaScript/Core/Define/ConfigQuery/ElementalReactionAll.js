...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configElementalReactionAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configElementalReactionAll.GetConfigList",
  );
  ...
  GetConfigList: (n = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        e = ElementalReaction_1.ElementalReaction.getRootAsElementalReaction(

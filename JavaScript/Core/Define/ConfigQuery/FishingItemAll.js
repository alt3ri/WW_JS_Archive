...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configFishingItemAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "b.捕鱼相关.xlsx",
  TABLE = "FishingItem",
  COMMAND = "select BinData from `FishingItem`",
  KEY_PREFIX = "FishingItemAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingItemAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configFishingItemAll.GetConfigList",
  );
  ...
  GetConfigList: (i = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = FishingItem_1.FishingItem.getRootAsFishingItem(

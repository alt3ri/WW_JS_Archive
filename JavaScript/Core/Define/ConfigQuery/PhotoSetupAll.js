...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configPhotoSetupAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configPhotoSetupAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = PhotoSetup_1.PhotoSetup.getRootAsPhotoSetup(

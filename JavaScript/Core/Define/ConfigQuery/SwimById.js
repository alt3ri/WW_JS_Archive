...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSwimById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSwimById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const C = Swim_1.Swim.getRootAsSwim(

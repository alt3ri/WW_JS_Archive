...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configBanInfoById = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "f.封禁处罚.xlsx",
  TABLE = "BanInfo",
  COMMAND = "select BinData from `BanInfo` where Id=?",
  KEY_PREFIX = "BanInfoById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configBanInfoById.Init"),
  getConfigStat = Stats_1.Stat.Create("configBanInfoById.GetConfig"),
  CONFIG_STAT_PREFIX = "configBanInfoById.GetConfig(";
    ...
    if (i) {
      ...
      if (
        ...
        if (
          ...
          const e = BanInfo_1.BanInfo.getRootAsBanInfo(

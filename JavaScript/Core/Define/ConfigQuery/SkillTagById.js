...
const SkillTag_1 = require("../Config/SkillTag");
const DB = "db_skill.db";
const FILE = "j.技能.xlsx";
const TABLE = "SkillTag";
const COMMAND = "select BinData from `SkillTag` where Id = ?";
const KEY_PREFIX = "SkillTagById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configSkillTagById.GetConfig(";

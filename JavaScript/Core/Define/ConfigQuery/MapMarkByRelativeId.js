...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configMapMarkByRelativeId = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "d.地图标记.xlsx",
  TABLE = "MapMark",
  COMMAND = "select BinData from `MapMark` where RelativeId=? and MapId=?",
  KEY_PREFIX = "MapMarkByRelativeId",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configMapMarkByRelativeId.Init",
  ),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configMapMarkByRelativeId.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configMapMarkByRelativeId.GetConfig(";

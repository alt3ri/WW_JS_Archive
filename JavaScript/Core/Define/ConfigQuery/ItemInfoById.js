...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configItemInfoById = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "d.道具.xlsx",
  TABLE = "ItemInfo",
  COMMAND = "select BinData from `ItemInfo` where Id=?",
  KEY_PREFIX = "ItemInfoById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configItemInfoById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configItemInfoById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configItemInfoById.GetConfig(";
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const f = ItemInfo_1.ItemInfo.getRootAsItemInfo(

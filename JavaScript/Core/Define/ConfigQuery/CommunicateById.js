...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configCommunicateById.Init"),
  getConfigStat = Stats_1.Stat.Create("configCommunicateById.GetConfig"),
    ...
    if (i) {
      ...
      if (
        ...
        if (
          ...
          const C = Communicate_1.Communicate.getRootAsCommunicate(

...
const COMMAND = "select BinData from `PhantomSubProperty` where Id=?";
const KEY_PREFIX = "PhantomSubPropertyById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configPhantomSubPropertyById.GetConfig(";

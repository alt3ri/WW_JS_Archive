...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configSpringChatById = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  SpringChat_1 = require("../Config/SpringChat"),
  DB = "db_activity.db",
  FILE = "c.2.0春节签到.xlsx",
  TABLE = "SpringChat",
  COMMAND = "select BinData from `SpringChat` where Id=?",
  KEY_PREFIX = "SpringChatById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSpringChatById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configSpringChatById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configSpringChatById.GetConfig(";
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const e = SpringChat_1.SpringChat.getRootAsSpringChat(

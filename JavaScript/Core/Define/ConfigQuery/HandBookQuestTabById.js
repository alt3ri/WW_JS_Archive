...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `HandBookQuestTab` where Id=?",
  KEY_PREFIX = "HandBookQuestTabById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configHandBookQuestTabById.Init",
  ),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configHandBookQuestTabById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configHandBookQuestTabById.GetConfig(";

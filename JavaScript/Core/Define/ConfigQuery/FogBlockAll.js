...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configFogBlockAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configFogBlockAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = FogBlock_1.FogBlock.getRootAsFogBlock(

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configStateMachinePreloadByAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `StateMachinePreload`",
  KEY_PREFIX = "StateMachinePreloadByAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configStateMachinePreloadByAll.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configStateMachinePreloadByAll.GetConfigList",
  );

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configBattleLinkCharacterAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `BattleLinkCharacter`",
  KEY_PREFIX = "BattleLinkCharacterAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configBattleLinkCharacterAll.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configBattleLinkCharacterAll.GetConfigList",
  );

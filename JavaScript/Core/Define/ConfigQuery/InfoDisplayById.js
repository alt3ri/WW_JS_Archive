...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configInfoDisplayById.Init"),
  getConfigStat = Stats_1.Stat.Create("configInfoDisplayById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const e = InfoDisplay_1.InfoDisplay.getRootAsInfoDisplay(

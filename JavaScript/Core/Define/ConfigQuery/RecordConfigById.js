...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRecordConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRecordConfigById.GetConfig",
  ),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const C = RecordConfig_1.RecordConfig.getRootAsRecordConfig(

...
const COMMAND = "select BinData from `CommonSkillPreload`";
const KEY_PREFIX = "CommonSkillPreloadAll";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = CommonSkillPreload_1.CommonSkillPreload.getRootAsCommonSkillPreload(

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configAdventureTaskById.Init"),
  getConfigStat = Stats_1.Stat.Create("configAdventureTaskById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const a = AdventureTask_1.AdventureTask.getRootAsAdventureTask(

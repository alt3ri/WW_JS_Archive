...
const COMMAND = "select BinData from `WeaponHideConfig` where Id=?";
const KEY_PREFIX = "WeaponHideConfigById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configWeaponHideConfigById.GetConfig(";

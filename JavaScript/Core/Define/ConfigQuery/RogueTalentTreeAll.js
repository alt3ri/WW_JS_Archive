...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configRogueTalentTreeAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configRogueTalentTreeAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = RogueTalentTree_1.RogueTalentTree.getRootAsRogueTalentTree(

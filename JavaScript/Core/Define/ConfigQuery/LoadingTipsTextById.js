...
const COMMAND = "select BinData from `LoadingTipsText` where Id=?";
const KEY_PREFIX = "LoadingTipsTextById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configLoadingTipsTextById.GetConfig(";
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          const t = LoadingTipsText_1.LoadingTipsText.getRootAsLoadingTipsText(

...
const COMMAND = "select BinData from `ChipHandBook` where Type=?";
const KEY_PREFIX = "ChipHandBookByType";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_LIST_STAT_PREFIX = "configChipHandBookByType.GetConfigList(";

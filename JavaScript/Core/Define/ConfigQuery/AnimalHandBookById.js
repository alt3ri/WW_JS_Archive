...
const COMMAND = "select BinData from `AnimalHandBook` where Id=?";
const KEY_PREFIX = "AnimalHandBookById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configAnimalHandBookById.GetConfig(";

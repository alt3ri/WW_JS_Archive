...
const Condition_1 = require("../Config/Condition");
const DB = "db_condition.db";
const FILE = "t.条件.xlsx";
const TABLE = "Condition";
const COMMAND = "select BinData from `Condition` where Id=?";
const KEY_PREFIX = "ConditionById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configConditionById.GetConfig(";

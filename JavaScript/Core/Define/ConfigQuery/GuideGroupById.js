...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configGuideGroupById.Init"),
  getConfigStat = Stats_1.Stat.Create("configGuideGroupById.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const C = GuideGroup_1.GuideGroup.getRootAsGuideGroup(

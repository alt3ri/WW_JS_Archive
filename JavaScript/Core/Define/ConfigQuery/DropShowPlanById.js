...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDropShowPlanById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configDropShowPlanById.GetConfig",
  ),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const C = DropShowPlan_1.DropShowPlan.getRootAsDropShowPlan(

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configAbyssInstAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "s.深渊爬塔副本.xlsx",
  TABLE = "AbyssInst",
  COMMAND = "select BinData from `AbyssInst`",
  KEY_PREFIX = "AbyssInstAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssInstAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configAbyssInstAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = AbyssInst_1.AbyssInst.getRootAsAbyssInst(

...
const COMMAND = "select BinData from `CombinationAxis` where Id=?";
const KEY_PREFIX = "CombinationAxisById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configCombinationAxisById.GetConfig(";

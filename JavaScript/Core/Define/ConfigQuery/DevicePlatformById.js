...
const COMMAND = "select BinData from `DevicePlatform` where Id=?";
const KEY_PREFIX = "DevicePlatformById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configDevicePlatformById.GetConfig(";

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configCookLevelAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configCookLevelAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        e = CookLevel_1.CookLevel.getRootAsCookLevel(

...
const COMMAND = "select BinData from `PhotoMontage` where Id=?";
const KEY_PREFIX = "PhotoMontageById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configPhotoMontageById.GetConfig(";
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          const i = PhotoMontage_1.PhotoMontage.getRootAsPhotoMontage(

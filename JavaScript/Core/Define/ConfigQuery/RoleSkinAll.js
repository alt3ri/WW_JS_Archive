...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configRoleSkinAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.角色.xlsx",
  TABLE = "RoleSkin",
  COMMAND = "select BinData from `RoleSkin`",
  KEY_PREFIX = "RoleSkinAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleSkinAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRoleSkinAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = RoleSkin_1.RoleSkin.getRootAsRoleSkin(

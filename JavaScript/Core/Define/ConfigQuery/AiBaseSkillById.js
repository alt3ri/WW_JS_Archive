...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  AiBaseSkill_1 = require("../Config/AiBaseSkill"),
  DB = "db_ai.db",
  FILE = "a.AI随机技能库.xlsx",
  TABLE = "AiBaseSkill",
  COMMAND = "select BinData from `AiBaseSkill` where Id=?",
  KEY_PREFIX = "AiBaseSkillById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAiBaseSkillById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configAiBaseSkillById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configAiBaseSkillById.GetConfig(";

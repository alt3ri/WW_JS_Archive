...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFunctionMenuAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configFunctionMenuAll.GetConfigList",
  );
  ...
  GetConfigList: (n = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = FunctionMenu_1.FunctionMenu.getRootAsFunctionMenu(

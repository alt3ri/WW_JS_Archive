...
const COMMAND = "select BinData from `AchievementGroup` where Id=?";
const KEY_PREFIX = "AchievementGroupById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configAchievementGroupById.GetConfig(";

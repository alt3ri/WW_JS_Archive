...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configQualityInfoAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configQualityInfoAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = QualityInfo_1.QualityInfo.getRootAsQualityInfo(

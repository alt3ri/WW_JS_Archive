...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMapBorderAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configMapBorderAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        i = MapBorder_1.MapBorder.getRootAsMapBorder(

...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configShareRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configShareRewardById.GetConfig",
  ),
    ...
    if (i) {
      ...
      if (
        ...
        if (
          ...
          const a = ShareReward_1.ShareReward.getRootAsShareReward(

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configDamageTextAll.Init"),
  getConfigListStat = Stats_1.Stat.Create("configDamageTextAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        e = DamageText_1.DamageText.getRootAsDamageText(

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configLoadingTipsTextAll.Init"),
  getConfigListStat = Stats_1.Stat.Create(
    "configLoadingTipsTextAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        t = LoadingTipsText_1.LoadingTipsText.getRootAsLoadingTipsText(

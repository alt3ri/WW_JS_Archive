...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSlideById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSlideById.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const C = Slide_1.Slide.getRootAsSlide(

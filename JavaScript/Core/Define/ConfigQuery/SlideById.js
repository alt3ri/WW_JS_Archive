...
const Slide_1 = require("../Config/Slide");
const DB = "db_slide.db";
const FILE = "h.滑行.xlsx";
const TABLE = "Slide";
const COMMAND = "select BinData from `Slide` where Id=?";
const KEY_PREFIX = "SlideById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configSlideById.GetConfig(";

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configShopInfoById.Init"),
  getConfigStat = Stats_1.Stat.Create("configShopInfoById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const e = ShopInfo_1.ShopInfo.getRootAsShopInfo(

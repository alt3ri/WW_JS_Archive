...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configRacingBetConversionRateById = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RacingBetConversionRate` where Id=?",
  KEY_PREFIX = "RacingBetConversionRateById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRacingBetConversionRateById.Init",
  ),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configRacingBetConversionRateById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configRacingBetConversionRateById.GetConfig(";

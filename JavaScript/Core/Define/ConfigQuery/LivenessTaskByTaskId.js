...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configLivenessTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.Create("configLivenessTaskByTaskId.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const a = LivenessTask_1.LivenessTask.getRootAsLivenessTask(

...
const TABLE = "MapMark";
const COMMAND = "select BinData from `MapMark` where EntityConfigId=?";
const KEY_PREFIX = "MapMarkByEntityConfigId";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configMapMarkByEntityConfigId.GetConfig(";

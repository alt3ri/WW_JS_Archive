...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "s.属性.xlsx",
  TABLE = "PropertyIndex",
  COMMAND = "select BinData from `PropertyIndex` where Id=?",
  KEY_PREFIX = "PropertyIndexById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPropertyIndexById.Init",
  ),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPropertyIndexById.GetConfig",
  ),
  CONFIG_STAT_PREFIX = "configPropertyIndexById.GetConfig(";
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const r = PropertyIndex_1.PropertyIndex.getRootAsPropertyIndex(

...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configItemHandBookById.Init"),
  getConfigStat = Stats_1.Stat.Create("configItemHandBookById.GetConfig"),
    ...
    if (e) {
      ...
      if (
        ...
        if (
          ...
          const a = ItemHandBook_1.ItemHandBook.getRootAsItemHandBook(

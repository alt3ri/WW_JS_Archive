...
let handleId = 0;
const initStat = Stats_1.Stat.Create("configMapAudioById.Init"),
  getConfigStat = Stats_1.Stat.Create("configMapAudioById.GetConfig"),
    ...
    if (t) {
      ...
      if (
        ...
        if (
          ...
          const a = MapAudio_1.MapAudio.getRootAsMapAudio(

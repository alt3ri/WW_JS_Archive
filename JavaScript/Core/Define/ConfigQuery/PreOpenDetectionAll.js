...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configPreOpenDetectionAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PreOpenDetection`",
  KEY_PREFIX = "PreOpenDetectionAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPreOpenDetectionAll.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPreOpenDetectionAll.GetConfigList",
  );
exports.configPreOpenDetectionAll = {
  Init: () => {
    initStat?.Start(),
  ...
  GetConfigList: (t = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        o = PreOpenDetection_1.PreOpenDetection.getRootAsPreOpenDetection(

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.configPayShopRecommendAll = void 0);
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PayShopRecommend`",
  KEY_PREFIX = "PayShopRecommendAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPayShopRecommendAll.Init",
  ),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph(
    "configPayShopRecommendAll.GetConfigList",
  );
  ...
  GetConfigList: (o = !0) => {
    ...
    if (
      ...
      for (;;) {
        ...
        e = PayShopRecommend_1.PayShopRecommend.getRootAsPayShopRecommend(

...
const RogueQualityConfig_1 = require("../Config/RogueQualityConfig");
const DB = "db_rogue.db";
const FILE = "r.肉鸽.xlsx";
const TABLE = "RogueQualityConfig";
const COMMAND = "select BinData from `RogueQualityConfig` where Id=?";
const KEY_PREFIX = "RogueQualityConfigById";
const logPair = [
  ["数据库", DB],
  ["文件", FILE],
  ["表名", TABLE],
...
const CONFIG_STAT_PREFIX = "configRogueQualityConfigById.GetConfig(";

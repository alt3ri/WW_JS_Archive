...
exports.packedType =
  exports.fixedTypedVectorElementSize =
  exports.fixedTypedVectorElementType =
  exports.typedVectorElementType =
  exports.toTypedVector =
  exports.isAVector =
  exports.isFixedTypedVector =
  exports.isTypedVector =
  exports.isTypedVectorElement =
  exports.isIndirectNumber =
  exports.isNumber =
  exports.isInline =
    void 0;
...
function isInline(value) {
  return (
    value === value_type_js_1.ValueType.BOOL ||
...
function isIndirectNumber(value) {
  return (
    value >= value_type_js_1.ValueType.INDIRECT_INT &&
...
function isTypedVector(value) {
  return (
    value === value_type_js_1.ValueType.VECTOR_BOOL ||
...
function isFixedTypedVector(value) {
  return (
    value >= value_type_js_1.ValueType.VECTOR_INT2 &&
...
function fixedTypedVectorElementType(valueType) {
  return (
    ((valueType - value_type_js_1.ValueType.VECTOR_INT2) % 3) +
    value_type_js_1.ValueType.INT
  );
}

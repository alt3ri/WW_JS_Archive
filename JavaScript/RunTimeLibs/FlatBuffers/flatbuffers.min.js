"use strict";
var flatbuffers = (() => {
  var I = (u, t) => () => (t || u((t = { exports: {} }).exports, t), t.exports);
  var _ = I((l) => {
    "use strict";
    Object.defineProperty(l, "__esModule", { value: !0 });
    l.SIZE_PREFIX_LENGTH =
    ...
    l.SIZEOF_SHORT = 2;
    l.SIZEOF_INT = 4;
    l.FILE_IDENTIFIER_LENGTH = 4;
    l.SIZE_PREFIX_LENGTH = 4;
  });
  var w = I((o) => {
    "use strict";
    Object.defineProperty(o, "__esModule", { value: !0 });
    o.isLittleEndian = o.float64 = o.float32 = o.int32 = void 0;
  ...
  var T = I((b) => {
    ...
    var j;
    (function (u) {
      (u[(u.UTF8_BYTES = 1)] = "UTF8_BYTES"),
        (u[(u.UTF16_STRING = 2)] = "UTF16_STRING");
    })((j = b.Encoding || (b.Encoding = {})));
  });
  var N = I((F) => {
    "use strict";
    ...
    var d = _(),
      ...
      f = class {
        ...
        readFloat32(t) {
          return (a.int32[0] = this.readInt32(t)), a.float32[0];
        }
        readFloat64(t) {
          return (
            (a.int32[a.isLittleEndian ? 0 : 1] = this.readInt32(t)),
            (a.int32[a.isLittleEndian ? 1 : 0] = this.readInt32(t + 4)),
            a.float64[0]
          );
        }
        writeInt8(t, e) {
        ...
        writeFloat32(t, e) {
          (a.float32[0] = e), this.writeInt32(t, a.int32[0]);
        }
        writeFloat64(t, e) {
          (a.float64[0] = e),
            this.writeInt32(t, a.int32[a.isLittleEndian ? 0 : 1]),
            this.writeInt32(t + 4, a.int32[a.isLittleEndian ? 1 : 0]);
        }
        getBufferIdentifier() {
          if (
            this.bytes_.length <
            this.position_ + d.SIZEOF_INT + d.FILE_IDENTIFIER_LENGTH
          )
            throw new Error(
              "FlatBuffers: ByteBuffer is too short to contain an identifier.",
            );
          let t = "";
          for (let e = 0; e < d.FILE_IDENTIFIER_LENGTH; e++)
            t += String.fromCharCode(
              this.readInt8(this.position_ + d.SIZEOF_INT + e),
            );
          return t;
        }
        __offset(t, e) {
        ...
        __string(t, e) {
          ...
          return e === m.Encoding.UTF8_BYTES ? s : this.text_decoder_.decode(s);
        }
        ...
        __vector(t) {
          return t + this.readInt32(t) + d.SIZEOF_INT;
        }
        __vector_len(t) {
          return this.readInt32(t + this.readInt32(t));
        }
        __has_identifier(t) {
          if (t.length != d.FILE_IDENTIFIER_LENGTH)
            throw new Error(
          ...
          for (let e = 0; e < d.FILE_IDENTIFIER_LENGTH; e++)
            if (
              t.charCodeAt(e) !=
              this.readInt8(this.position() + d.SIZEOF_INT + e)
            )
              return !1;
          return !0;
        }
    ...
    var S = N(),
      ...
      E = class {
        constructor(t) {
          ...
          let e;
          t ? (e = t) : (e = 1024),
            (this.bb = S.ByteBuffer.allocate(e)),
            (this.space = e);
        }
        clear() {
          this.bb.clear(),
        ...
        prep(t, e) {
          ...
          let i = (~(this.bb.capacity() - this.space + e) + 1) & (t - 1);
          for (; this.space < i + t + e; ) {
            let s = this.bb.capacity();
            (this.bb = E.growByteBuffer(this.bb)),
              (this.space += this.bb.capacity() - s);
          }
          this.pad(i);
        }
        pad(t) {
        ...
        static growByteBuffer(t) {
          ...
          let i = e << 1,
            s = S.ByteBuffer.allocate(i);
          return s.setPosition(i - e), s.bytes().set(t.bytes(), i - e), s;
        }
        addOffset(t) {
          this.prep(h.SIZEOF_INT, 0),
            this.writeInt32(this.offset() - t + h.SIZEOF_INT);
        }
        startObject(t) {
          this.notNested(),
        ...
        endObject() {
          ...
          let n = (i + s) * h.SIZEOF_SHORT;
          this.addInt16(n);
          let c = 0,
            B = this.space;
          t: for (e = 0; e < this.vtables.length; e++) {
            let O = this.bb.capacity() - this.vtables[e];
            if (n == this.bb.readInt16(O)) {
              for (let p = h.SIZEOF_SHORT; p < n; p += h.SIZEOF_SHORT)
                if (this.bb.readInt16(B + p) != this.bb.readInt16(O + p))
                  continue t;
              c = this.vtables[e];
              break;
            }
          ...
          return (
            c
              ? ((this.space = this.bb.capacity() - t),
                this.bb.writeInt32(this.space, c - t))
        ...
        finish(t, e, i) {
          let s = i ? h.SIZE_PREFIX_LENGTH : 0;
          if (e) {
            let n = e;
            if (
              (this.prep(
                this.minalign,
                h.SIZEOF_INT + h.FILE_IDENTIFIER_LENGTH + s,
              ),
              n.length != h.FILE_IDENTIFIER_LENGTH)
            )
              throw new TypeError(
                "FlatBuffers: file identifier must be length " +
                  h.FILE_IDENTIFIER_LENGTH,
              );
            for (let c = h.FILE_IDENTIFIER_LENGTH - 1; c >= 0; c--)
              this.writeInt8(n.charCodeAt(c));
          }
          this.prep(this.minalign, h.SIZEOF_INT + s),
            this.addOffset(t),
            s && this.addInt32(this.bb.capacity() - this.space),
        ...
        createString(t) {
          if (t == null) return 0;
          let e;
          t instanceof Uint8Array ? (e = t) : (e = this.text_encoder.encode(t)),
            this.addInt8(0),
            this.startVector(1, e.length, 1),
            this.bb.setPosition((this.space -= e.length));
          for (
            let i = 0, s = this.space, n = this.bb.bytes();
            i < e.length;
            i++
          )
            n[s++] = e[i];
        ...
        createObjectOffsetList(t) {
          ...
          for (let i = 0; i < t.length; ++i) {
            let s = t[i];
            if (s !== null) e.push(this.createObjectOffset(s));
            else
              throw new TypeError(
  ...
  var D = I((r) => {
    ...
    r.ByteBuffer =
      ...
      r.float32 =
      r.int32 =
      r.SIZE_PREFIX_LENGTH =
      r.FILE_IDENTIFIER_LENGTH =
      r.SIZEOF_INT =
      r.SIZEOF_SHORT =
        void 0;
    var v = _();
    Object.defineProperty(r, "SIZEOF_SHORT", {
      enumerable: !0,
      get: function () {
        return v.SIZEOF_SHORT;
      },
    });
    var R = _();
    Object.defineProperty(r, "SIZEOF_INT", {
      enumerable: !0,
      get: function () {
        return R.SIZEOF_INT;
      },
    ...
    var U = _();
    Object.defineProperty(r, "FILE_IDENTIFIER_LENGTH", {
      enumerable: !0,
      get: function () {
        return U.FILE_IDENTIFIER_LENGTH;
      },
    });
    var Z = _();
    Object.defineProperty(r, "SIZE_PREFIX_LENGTH", {
      enumerable: !0,
      get: function () {
        return Z.SIZE_PREFIX_LENGTH;
      },
    });
    var g = w();
    Object.defineProperty(r, "int32", {
      enumerable: !0,
      get: function () {
        return g.int32;
      },
    });
    Object.defineProperty(r, "float32", {
      enumerable: !0,
      get: function () {
        return g.float32;
      },
    });
    Object.defineProperty(r, "float64", {
      enumerable: !0,
      get: function () {
        return g.float64;
      },
    ...
    var G = N();
    Object.defineProperty(r, "ByteBuffer", {
      enumerable: !0,
      get: function () {
        return G.ByteBuffer;
      },

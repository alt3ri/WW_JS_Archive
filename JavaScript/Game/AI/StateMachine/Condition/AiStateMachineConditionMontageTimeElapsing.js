...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.AiStateMachineConditionMontageTimeElapsing = void 0);
...
class AiStateMachineConditionMontageTimeElapsing extends AiStateMachineCondition_1.AiStateMachineCondition {
  ...
  OnInit(t) {
    return (
      ...
      (this.Ql = 0.001 * t.CondMontageTimeElapsing.Time),
      102 !== this.Node.Task?.Type &&
      3 !== this.Node.Task?.Type &&
      105 !== this.Node.Task?.Type
        ? this.Node.Owner.PushErrorMessage(
            `初始化条件[动画播放时间]失败，node[${this.Node.Name}|${this.Node.Uuid}], to:` +
              this.Transition.To,
          )
...
exports.AiStateMachineConditionMontageTimeElapsing =
  AiStateMachineConditionMontageTimeElapsing;

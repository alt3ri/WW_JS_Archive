...
class TsTaskNpcPatrol extends TsTaskAbortImmediatelyBase_1.default {
  ...
  InitBaseInfo() {
    this.CacheVector ||
      ...
      (this.StateComp = this.Entity.GetComponent(160)),
      (this.AnimComp = this.Entity.GetComponent(162)),
      (this.AiComp = this.Entity.GetComponent(39)),
      (this.CurTime = 0),
      (this.IsInit = !1),
      (this.IsPause = !1),
      (this.ForceExit = !1),
  ...
  HandleChangedState(t, i) {
    this.IsInit &&
      (i === CharacterUnifiedStateTypes_1.ECharMoveState.Other
        ? (this.ForceExit = !0)
    ...
    this.ForceExit
      ...
      : this.IsPause ||
        (0 < this.ChangeMoveTimeInternal &&
          ...
          this.MoveToPatrolPoint(),
        (this.CurTime += s),
        this.CurTime > CHECK_RAYCAST_INTERVAL &&
  ...
  PatrolError() {
    ...
    (this.IsPause = !0),
      AiPatrolController_1.AiPatrolController.OpenNpcPatrolDebugMode &&
        ...
        (i = this.PatrolLogic.PatrolPoint.Point),
        Log_1.Log.CheckWarn() &&
          Log_1.Log.Warn(
            "AI",
            43,

...
const Info_1 = require("../../Core/Common/Info"),
  ...
  EffectAudioController_1 = require("../Effect/EffectSpec/EffectAudioController"),
  ...
  BigStuffedDollController_1 = require("../LevelGamePlay/BigStuffedDoll/BigStuffedDollController"),
  CipherController_1 = require("../LevelGamePlay/Cipher/CipherController"),
  FollowShooterHackController_1 = require("../LevelGamePlay/FollowShooterHack/FollowShooterHackController"),
  GongduolaSummonController_1 = require("../LevelGamePlay/GongduolaSummon/GongduolaSummonController"),
  GravityFlipController_1 = require("../LevelGamePlay/GravityFlip/GravityFlipController"),
  ...
  SplineMoveTaskController_1 = require("../LevelGamePlay/SplineMoveTask/SplineMoveTaskController"),
  ...
  ChessController_1 = require("../Module/Activity/ActivityContent/ChessGameplay/ChessController"),
  FishingController_1 = require("../Module/Activity/ActivityContent/Fishing/FishingController"),
  ...
  BirthdayController_1 = require("../Module/Birthday/BirthdayController"),
  ...
  CiacconaGalController_1 = require("../Module/CiacconaGal/CiacconaGalController"),
  ...
  DangoAbyssController_1 = require("../Module/Dango/DangoAbyss/DangoAbyssController"),
  DangoGlobalController_1 = require("../Module/Dango/DangoGlobal/DangoGlobalController"),
  ...
  InstanceGameplayModeController_1 = require("../Module/InstanceGameplayMode/InstanceGameplayModeController"),
  ...
  LevelPlayReportController_1 = require("../Module/LevelPlayReport/LevelPlayReportController"),
  ...
  GamepadLogReportController_1 = require("../Module/LogReport/GamepadLogReportController"),
  ...
  MailBindController_1 = require("../Module/MailBind/MailBindController"),
  ...
  MapRogueController_1 = require("../Module/MapRogue/MapRogueController"),
  ...
  PreDownloadController_1 = require("../Module/MobilePredownload/PreDownloadController"),
  ...
  VisionEquipGroupController_1 = require("../Module/Phantom/PhantomBattle/VisionEquipGroupController"),
  VisionRecommendController_1 = require("../Module/Phantom/PhantomBattle/VisionRecommendController"),
  ...
  BattleQteController_1 = require("../Module/Qte/BattleQte/BattleQteController"),
  ...
  RogueBattleController_1 = require("../Module/RogueBattle/RogueBattleController"),
  ...
  SceneBattleInteractController_1 = require("../Module/SceneBattleInteract/SceneBattleInteractController"),
  ...
  ShipTowerController_1 = require("../Module/ShipTower/ShipTowerController"),
  ...
  SkinController_1 = require("../Module/Skin/SkinController"),
  FlySkinController_1 = require("../Module/Skin/Tab/Fly/FlySkinController"),
  WeaponSkinController_1 = require("../Module/Skin/Tab/Weapon/WeaponSkinController"),
  ...
  SplashScreenController_1 = require("../Module/SplashScreen/SplashScreenController"),
  TeleportController_1 = require("../Module/Teleport/TeleportController"),
  TermExplanationController_1 = require("../Module/TermExplanation/TermExplanationController"),
  ...
  TreasureHuntController_1 = require("../Module/TreasureHunt/TreasureHuntController"),
  ...
  PerformController_1 = require("../NewWorld/Character/Common/Component/Performance/PerformController"),
  MonsterGroupPatrolController_1 = require("../NewWorld/Character/Monster/Controller/MonsterGroupPatrolController"),
  ...
  VehicleController_1 = require("../NewWorld/Vehicle/Controller/VehicleController"),
  ...
  PlayerSoarMonitorController_1 = require("../World/Controller/PlayerSoarMonitorController"),
  ...
  SyncSplineMoveController_1 = require("../World/Controller/SyncSplineMoveController"),
  TimeController_1 = require("../World/Controller/TimeController"),
...
class ControllerRegisterManager {
  ...
  static OnInit() {
    return (
      ...
      (ControllerHolder_1.ControllerHolder.LevelPickInteractController =
        LevelPickInteractController_1.LevelPickInteractController),
      this.qp(LevelPickInteractController_1.LevelPickInteractController),
      ...
      (ControllerHolder_1.ControllerHolder.CreatureGroupController =
        CreatureGroupController_1.CreatureGroupController),
      this.qp(CreatureGroupController_1.CreatureGroupController),
      ...
      (ControllerHolder_1.ControllerHolder.TimeController =
        TimeController_1.TimeController),
      this.qp(TimeController_1.TimeController),
      ...
      (ControllerHolder_1.ControllerHolder.PhonographController =
        PhonographController_1.PhonographController),
      this.qp(PhonographController_1.PhonographController),
      ...
      (ControllerHolder_1.ControllerHolder.RogueBattleController =
        RogueBattleController_1.RogueBattleController),
      this.qp(RogueBattleController_1.RogueBattleController),
      ...
      (ControllerHolder_1.ControllerHolder.PerformController =
        PerformController_1.PerformController),
      this.qp(PerformController_1.PerformController),
      ...
      (ControllerHolder_1.ControllerHolder.PlayerSoarMonitorController =
        PlayerSoarMonitorController_1.PlayerSoarMonitorController),
      ...
      (ControllerHolder_1.ControllerHolder.WeaponSkinController =
        WeaponSkinController_1.WeaponSkinController),
      this.qp(WeaponSkinController_1.WeaponSkinController),
      (ControllerHolder_1.ControllerHolder.FlySkinController =
        FlySkinController_1.FlySkinController),
      this.qp(FlySkinController_1.FlySkinController),
      (ControllerHolder_1.ControllerHolder.SkinController =
        SkinController_1.SkinController),
      this.qp(SkinController_1.SkinController),
      (ControllerHolder_1.ControllerHolder.GamepadLogReportController =
        GamepadLogReportController_1.GamepadLogReportController),
      this.qp(GamepadLogReportController_1.GamepadLogReportController),
      (ControllerHolder_1.ControllerHolder.VehiclePathMoveController =
        VehiclePathMoveController_1.VehiclePathMoveController),
      this.qp(VehiclePathMoveController_1.VehiclePathMoveController),
      ...
      (ControllerHolder_1.ControllerHolder.BattleLinkController =
        BattleLinkController_1.BattleLinkController),
      this.qp(BattleLinkController_1.BattleLinkController),
      (ControllerHolder_1.ControllerHolder.ResetTimeController =
        ResetTimeController_1.ResetTimeController),
      this.qp(ResetTimeController_1.ResetTimeController),
      (ControllerHolder_1.ControllerHolder.MailBindController =
        MailBindController_1.MailBindController),
      this.qp(MailBindController_1.MailBindController),
      (ControllerHolder_1.ControllerHolder.VehicleController =
        VehicleController_1.VehicleController),
      this.qp(VehicleController_1.VehicleController),
      (ControllerHolder_1.ControllerHolder.BigStuffedDollController =
        BigStuffedDollController_1.BigStuffedDollController),
      this.qp(BigStuffedDollController_1.BigStuffedDollController),
      (ControllerHolder_1.ControllerHolder.MonsterGroupPatrolController =
        MonsterGroupPatrolController_1.MonsterGroupPatrolController),
      this.qp(MonsterGroupPatrolController_1.MonsterGroupPatrolController),
      (ControllerHolder_1.ControllerHolder.LevelPlayReportController =
        LevelPlayReportController_1.LevelPlayReportController),
      this.qp(LevelPlayReportController_1.LevelPlayReportController),
      (ControllerHolder_1.ControllerHolder.FishingController =
        FishingController_1.FishingController),
      this.qp(FishingController_1.FishingController),
      (ControllerHolder_1.ControllerHolder.CommonQteController =
        CommonQteController_1.CommonQteController),
      this.qp(CommonQteController_1.CommonQteController),
      (ControllerHolder_1.ControllerHolder.BattleQteController =
        BattleQteController_1.BattleQteController),
      this.qp(BattleQteController_1.BattleQteController),
      (ControllerHolder_1.ControllerHolder.TreasureHuntController =
        TreasureHuntController_1.TreasureHuntController),
      this.qp(TreasureHuntController_1.TreasureHuntController),
      (ControllerHolder_1.ControllerHolder.VisionRecommendController =
        VisionRecommendController_1.VisionRecommendController),
      this.qp(VisionRecommendController_1.VisionRecommendController),
      (ControllerHolder_1.ControllerHolder.ShipTowerController =
        ShipTowerController_1.ShipTowerController),
      this.qp(ShipTowerController_1.ShipTowerController),
      (ControllerHolder_1.ControllerHolder.MapRogueController =
        MapRogueController_1.MapRogueController),
      this.qp(MapRogueController_1.MapRogueController),
      (ControllerHolder_1.ControllerHolder.VisionEquipGroupController =
        VisionEquipGroupController_1.VisionEquipGroupController),
      this.qp(VisionEquipGroupController_1.VisionEquipGroupController),
      (ControllerHolder_1.ControllerHolder.FollowShooterHackController =
        FollowShooterHackController_1.FollowShooterHackController),
      this.qp(FollowShooterHackController_1.FollowShooterHackController),
      (ControllerHolder_1.ControllerHolder.DangoAbyssController =
        DangoAbyssController_1.DangoAbyssController),
      this.qp(DangoAbyssController_1.DangoAbyssController),
      (ControllerHolder_1.ControllerHolder.GravityFlipController =
        GravityFlipController_1.GravityFlipController),
      this.qp(GravityFlipController_1.GravityFlipController),
      (ControllerHolder_1.ControllerHolder.GongduolaSummonController =
        GongduolaSummonController_1.GongduolaSummonController),
      this.qp(GongduolaSummonController_1.GongduolaSummonController),
      (ControllerHolder_1.ControllerHolder.SyncSplineMoveController =
        SyncSplineMoveController_1.SyncSplineMoveController),
      this.qp(SyncSplineMoveController_1.SyncSplineMoveController),
      (ControllerHolder_1.ControllerHolder.SplineMoveTaskController =
        SplineMoveTaskController_1.SplineMoveTaskController),
      this.qp(SplineMoveTaskController_1.SplineMoveTaskController),
      (ControllerHolder_1.ControllerHolder.EffectAudioController =
        EffectAudioController_1.EffectAudioController),
      this.qp(EffectAudioController_1.EffectAudioController),
      (ControllerHolder_1.ControllerHolder.ChessController =
        ChessController_1.ChessController),
      this.qp(ChessController_1.ChessController),
      (ControllerHolder_1.ControllerHolder.CiacconaGalController =
        CiacconaGalController_1.CiacconaGalController),
      this.qp(CiacconaGalController_1.CiacconaGalController),
      (ControllerHolder_1.ControllerHolder.InstanceGameplayModeController =
        InstanceGameplayModeController_1.InstanceGameplayModeController),
      this.qp(InstanceGameplayModeController_1.InstanceGameplayModeController),
      (ControllerHolder_1.ControllerHolder.DangoGlobalController =
        DangoGlobalController_1.DangoGlobalController),
      this.qp(DangoGlobalController_1.DangoGlobalController),
      "true" ===
      ...
      (ControllerHolder_1.ControllerHolder.SubLevelController =
        SubLevelController_1.SubLevelController),
      this.qp(SubLevelController_1.SubLevelController),
      (ControllerHolder_1.ControllerHolder.PreDownloadController =
        PreDownloadController_1.PreDownloadController),
      this.qp(PreDownloadController_1.PreDownloadController),
      (ControllerHolder_1.ControllerHolder.SceneBattleInteractController =
        SceneBattleInteractController_1.SceneBattleInteractController),
      this.qp(SceneBattleInteractController_1.SceneBattleInteractController),
      (ControllerHolder_1.ControllerHolder.TermExplanationController =
        TermExplanationController_1.TermExplanationController),
      this.qp(TermExplanationController_1.TermExplanationController),
      (ControllerHolder_1.ControllerHolder.SplashScreenController =
        SplashScreenController_1.SplashScreenController),
      this.qp(SplashScreenController_1.SplashScreenController),
      (ControllerHolder_1.ControllerHolder.BirthdayController =
        BirthdayController_1.BirthdayController),
      this.qp(BirthdayController_1.BirthdayController),
      !0
    );
  }
  static RegisterTick() {
    return (
      ...
      this.PBe(TimeController_1.TimeController),
      ...
      this.PBe(EffectAudioController_1.EffectAudioController),
      this.PBe(CiacconaGalController_1.CiacconaGalController),
      this.PBe(TermExplanationController_1.TermExplanationController),
      this.PBe(SceneBattleInteractController_1.SceneBattleInteractController),
      this.PBe(SplineMoveTaskController_1.SplineMoveTaskController),
      !0
    );
  }
  static qp(r) {

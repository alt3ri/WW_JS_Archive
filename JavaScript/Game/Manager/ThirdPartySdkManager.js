...
class ThirdPartySdkManager {
  static Init() {
    var r =
      ...
      r =
        ...
        UE.KuroLauncherLibrary.GetAppChangeList()),
      e =
  ...
  static rPn() {
    ...
    UE.BlueprintPathsLibrary.FileExists(r) &&
      (Log_1.Log.CheckError() && Log_1.Log.Error("Login", 21, "崩溃测试！"),
  ...
  static NBe() {
    ...
    Net_1.Net.IsServerConnected() &&
      0 < (r = cpp_1.FTpSafeProxy.GetAntiData()).byteLength &&
      (((e = Protocol_1.Aki.Protocol.e$n.create()).v6n = new Uint8Array(r)),
      Net_1.Net.Send(28584, e));
  }
  static GBe() {

...
class ModelManagerCreator {
  static Init() {
    return (
      ...
      (ModelManager_1.ModelManager.AttachToActorModel =
        new AttachToActorModel_1.AttachToActorModel()),
      ModelManager_1.ModelManager.Add(
        ModelManager_1.ModelManager.AttachToActorModel,
      ),
      ...
      (ModelManager_1.ModelManager.BattleScoreModel =
        new BattleScoreModel_1.BattleScoreModel()),
      ModelManager_1.ModelManager.Add(
        ModelManager_1.ModelManager.BattleScoreModel,
      ),
      ...
      (ModelManager_1.ModelManager.PreloadModelNew =
        new PreloadModelNew_1.PreloadModelNew()),
      ModelManager_1.ModelManager.Add(
        ModelManager_1.ModelManager.PreloadModelNew,
      ),
      ...
      (ModelManager_1.ModelManager.FragmentMemoryModel =
        new FragmentMemoryModel_1.FragmentMemoryModel()),
      ModelManager_1.ModelManager.Add(
        ModelManager_1.ModelManager.FragmentMemoryModel,
      ),
      ...
      (ModelManager_1.ModelManager.PortalModel =
        new PortalModel_1.PortalModel()),
  ...
  static Clear() {
    return (
      ...
      (ModelManager_1.ModelManager.AttachToActorModel = void 0),
      ...
      (ModelManager_1.ModelManager.PreloadModelNew = void 0),
      ...
      (ModelManager_1.ModelManager.FragmentMemoryModel = void 0),

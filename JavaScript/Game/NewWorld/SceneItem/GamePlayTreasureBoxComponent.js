  ...
  (SceneItemTreasureBoxComponent_1 = class SceneItemTreasureBoxComponent extends (
    ...
    constructor() {
      super(...arguments),
        ...
        (this.m1n = () => {
          this.ccn(),
            this.Entity.CheckGetComponent(131).IsInState(2) && this.mcn();
        }),
        (this.dcn = (e) => {
          this.ccn();
        }),
    ...
    OnActivate() {
      return (
        ...
        (this.ucn = void 0),
        this.Entity.CheckGetComponent(131).IsInState(0) || this.m1n(),
        !0
      );
    }
    OnEnd() {
    ...
    ccn() {
      var e = this.Entity.CheckGetComponent(131),
        t = this.Entity.CheckGetComponent(194);
      let n = void 0,
        r = void 0;
      switch (e.State) {
        case 1:
          n = this.Entity.CheckGetComponent(128).IsLocked

...
class BulletActionRunner {
  ...
  Run(t = 0, e = !1) {
    if (this.ac !== 0)
      ...
      this.ac = 2;
      const r = ModelManager_1.ModelManager.BulletModel.GetBulletEntityMap();
      if (t > 0) {
        (this.B5o.length = 0), (this.b5o.length = 0);
        for (const s of r.values()) {
          const o = s.GetBulletInfo();
          this.B5o.push(o);
        }
      }
      for (this.N5o(t, e), this.B5o.length = 0; this.b5o.length > 0; ) {
        const i = this.B5o;
        (this.B5o = this.b5o),
          (this.b5o = i),
          this.N5o(0),
  ...
  N5o(t = 0, e = !1) {
    ...
    for (const l of this.B5o) {
      ...
      try {
        if (((this.q5o = l), t > 0)) {
          const i = l.PersistentActionList;
        ...
        for (
          ;
          l.ActionInfoList.length > 0 || l.NextActionInfoList.length > 0;

        ) {
          for (const h of l.ActionInfoList) {
            const n = o.CreateBulletAction(h.Type);

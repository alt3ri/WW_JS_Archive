...
class BulletBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static CreateBulletFromGA(t, e, r, l, a = !0, o = void 0) {
    ...
    return "" === l
      ? (Log_1.Log.CheckError() &&
          Log_1.Log.Error("Bullet", 35, "CreateBulletFromGA的SkillId为空", [
            "bullet",
            e,
          ]),
        -1)
      : ((i = BulletUtil_1.BulletUtil.GetSkillContextId(
        ...
        (e = BulletController_1.BulletController.CreateBulletCustomTarget(
          ...
          r,
          {
            ...
            BattleFlags: t
              ...
              ?.GetComponent(38)
              ?.GetSkill(Number(l))?.BattleFlags,
          },
          i,
        ))
          ? ((e.GetBulletInfo().CreateSource = 1), e.Id)
          : -1);
  }
  static GetBulletActorById(t) {
    t = EntitySystem_1.EntitySystem.Get(t);
    if (t?.Valid) return t.GetComponent(167).Owner;
  }
    ...
    if (
      ...
      r =
        ...
        1 === a.移动设置.运动轨迹参数目标
          ? ((t = u.GetLocation()),
            (e = u.Rotator().Yaw),
            u.GetRotation().GetForwardVectorDouble())
          : ((t = i.GetLocation()),
            (e = i.GetRotation().Rotator().Yaw),
            i.GetRotation().VectorDouble());
  ...
  static AttachToBone(t, e, r) {
    ...
    0 === l
      ...
      : 3 === l &&
        ...
        e.D_K2_SetActorRelativeLocation(l, !1, void 0, !1),
    ...
    switch (e.移动设置.运动轨迹类型) {
      ...
      case 3: {
        ...
        (u = (t =
          ...
          6 === e.移动设置.运动轨迹参数目标 ||
          1 === e.移动设置.运动轨迹参数目标
            ? l.D_K2_GetActorLocation()
            : a)
          .op_Subtraction(r.D_K2_GetActorLocation())
          .RotateAngleAxis(n, i.ToUeVector())),
          (n = t.op_Addition(u));
        r.K2_SetActorRotation(
          UE.KismetMathLibrary.D_FindLookAtRotation(t, n),
          !1,
        ),
          r.D_K2_SetActorLocation(n, !1, void 0, !0);
        break;
      }
    }
  ...
  static CalcBulletLocation(t, e, r) {
    return e
      ...
      .op_Addition(
        e.D_GetActorForwardVector().op_Multiply(t.移动设置.移动速度 * r),
      );
  }
}

...
class TsMeshAnimBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static MainAnimInstance(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 175)?.MainAnimInstance;
  }
  static GetSightDirect(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 43)?.GetSightDirect();
  }
  static GetHulu(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 79)?.Hulu;
  }
  static GetBattleIdleTime(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 175)?.BattleIdleEndTime;
  }
  static EnterBattleIdle(t) {
    EntitySystem_1.EntitySystem.GetComponent(t, 175)?.EnterBattleIdle();
  }
  ...
  static HideWeaponsWhenHideBones(t, e, i) {
    EntitySystem_1.EntitySystem.GetComponent(t, 79)?.HideWeaponsWhenHideBones(
      e,
      i,
    );
  }
  static ChangeWeaponHangState(t, e, i, n, r) {
    EntitySystem_1.EntitySystem.GetComponent(t, 79)?.ChangeWeaponHangState(
      e,
      (0, puerts_1.$unref)(n),
      (0, puerts_1.$unref)(r),
      i,
  ...
  static GetCurrentWeaponHangState(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 79)?._Pr;
  }
  ...
  static HideWeapon(t, e, i, n, r = !1) {
    EntitySystem_1.EntitySystem.GetComponent(t, 79)?.HideWeapon(
      i,
      e,
      n,
      !1,
  ...
  static HideHulu(t, e) {
    EntitySystem_1.EntitySystem.GetComponent(t, 79)?.SetHuluHidden(e);
  }
  static ChangeMeshAnim(t, e, i) {
    EntitySystem_1.EntitySystem.GetComponent(t, 3)?.ChangeMeshAnim(e, i);
  }
  static GetDegMovementSlope(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 175)?.DegMovementSlope;
  }
  ...
  static GetWeaponBreachLevel(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 79);
  ...
  static UpdateAnimInfoMeshAnim(t, e) {
    ...
    r?.Valid &&
      ...
      i.SightDirect.Equals(n) ||
        (i.SightDirect.DeepCopy(n), (e.SightDirectRef = n.ToUeVectorOld())),
            ...
            if (s?.IsValid()) {
              ...
              if (a.CharRenderingComponent.GetInWater())
                ...
                t = UE.KuroVoxelSystem.GetMtlNameByID(
                  VoxelUtils_1.VoxelUtils.GetVoxelInfo(a, r).MtlID,
                );
              }
  ...
  static ChangeTickOverlap(t, e) {
    EntitySystem_1.EntitySystem.GetComponent(t, 112).SetTakeOverTick(e);
  }
  ...
  static IsNpcTurning(t) {
    return !!EntitySystem_1.EntitySystem.GetComponent(t, 179)?.IsTurning;
  }
  static UpdateAndGetRotateBonesMap(t, e, i, n) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 175);
    t &&
      t.RotateBonesToTargetMgr &&

"use strict";
function checkBuffInSpecialList(t) {
  if (exports.specialIgnoreBuff.includes(t)) return !0;
  if (exports.specialIgnoreGaBuff.includes(t)) return !0;
  let n = Object.values(exports.gameplayAbilityVisionBuffId);
  return (
    !!n.includes(t) ||
    !!(n = Object.values(exports.fillElementBuffId)).includes(t) ||
    !!(n = Object.values(exports.buffId)).includes(t)
  );
}
function checkBulletInSpecialList(t) {
  return !!exports.specialIgnoreBullet.includes(t);
}

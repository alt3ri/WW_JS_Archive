...
class TsAnimNotifyStateJumpLandDetect extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    ...
    const c = Transform_1.Transform.Create(o.GetTransform());
    const _ = this.GetCurveTransform(t, 0);
    const u = this.GetCurveTransform(t, r).GetLocation();
    const f =
  ...
  Move(t, e) {
    const r = t.Entity.GetComponent(3);
  ...
  GetCurveTransform(t, e) {
    const r = t.GetMainAnimsCurveValueWithDelta(this.RootNameX, e);
    const o = t.GetMainAnimsCurveValueWithDelta(this.RootNameY, e);
    const i = t.GetMainAnimsCurveValueWithDelta(this.RootNameZ, e);
    var t = t.GetMainAnimsCurveValueWithDelta(this.RootLookName, e);

...
class RoleListItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  HH_(e) {
    var t,
      i = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems(!0);
    let s = void 0,
      o = 1;
    ...
    void 0 !== s
      ? ((t = Math.min(o, ROLE_MAX_POSITION)),
        this.$H_("SP_RoleFormationPosition" + t))
      : this.$H_();
  }
  jH_(t) {
    ...
    t <= 0
      ? this.$H_()
      : ((t = Math.ceil(t / EditFormationDefine_1.EDITE_FORAMTION_MAX_NUM)),
        this.$H_("SP_TeamEditFormation_" + t, !0));
  }
  $H_(t, e = !1) {
    var i = void 0 !== t;
    this.GetItem(2).SetUIActive(i),
      ...
      i &&
        ...
        this.SetSpriteByPath(i, this.GetSprite(3), e));
  }
  GetRedDotItem() {

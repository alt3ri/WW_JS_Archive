...
class RoleListComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments),
      ...
      (this.Hke = () => {
        const e = new RoleListItem_1.RoleListItem();
        return (
  ...
  get CurSelectDataId() {
    const e = this.ScrollView.GetGenericLayout().GetSelectedGridIndex();
  ...
  async UpdateComponent(e) {
    const t = [];
    for (const o of e) {
      const i = new RoleListItem_1.RoleListItemData();
      (i.RoleDataId = o),
  ...
  SetCurSelection(t) {
    let e = this.DataList.findIndex((e) => e.RoleDataId === t);
    e < 0 ||

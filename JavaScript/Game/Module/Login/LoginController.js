...
const VERIFY_CONFIG_VERSION_INTERVAL = 9e4;
...
class LoginController extends UiControllerBase_1.UiControllerBase {
  ...
  static OpenLoginView() {
    ...
    let e = UE.GameplayStatics.GetPlayerController(
      GlobalData_1.GlobalData.World,
      0,
    ).GetViewTarget();
    const o = e.K2_GetActorLocation();
    const r = e.K2_GetActorRotation();
    const n = e.CameraComponent.FieldOfView;
    void 0 !== e &&
      void 0 !== n &&
      void 0 !==
        (e =
  ...
  static Tvi() {
    ...
    const r = ModelManager_1.ModelManager.LoginModel.TryGetRealServerPort();
    const n = ModelManager_1.ModelManager.LoginModel.SetRpcHttp(
      LoginController.Lvi,
      13e3,
    );
    ...
    const a = t.UserName;
    var t = t.Token;
    const g = UE.KuroStaticLibrary.HashStringWithSHA1(t);
    const l = UE.KuroSDKManager.GetBasicInfo()?.DeviceId ?? "0";
  ...
  static Dvi() {
    ...
    const o = ModelManager_1.ModelManager.LoginModel.SetRpcHttp(
      LoginController.Lvi,
      13e3,
    );
    ...
    const i = r.UserName;
    var r = r.Token;
    const t = UE.KuroStaticLibrary.HashStringWithSHA1(r);
    const a = UE.KuroSDKManager.GetBasicInfo()?.DeviceId ?? "0";
  ...
  static async HandleLoginGame(e, o) {
    const r = await LoginController.EnterGameAsync();
    return (
      e
        ? (Log_1.Log.CheckInfo() &&
            Log_1.Log.Info(
  ...
  static async Pvi(e, o, r) {
    ...
    const n = await Net_1.Net.ConnectAsync(o, r, 3e3, 3);
    return n !== 0
      ? (ModelManager_1.ModelManager.LoginModel.AddLoginFailCount(),
  ...
  static async wvi(e) {
    ...
    const o = new Protocol_1.Aki.Protocol.mis();
    let r =
      (ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk()
        ? (o.s6n =
  ...
  static async qvi(e, o = 0) {
    let r = ModelManager_1.ModelManager.LoginModel.GetLoginStatus();
    if (
        ...
        return (
          ...
          r.Kms === Protocol_1.Aki.Protocol.lkn.Proto_LoginRetry
            ? (LoginController.LogLoginProcessLink(
              ...
              o >= 5 ? r : await LoginController.qvi(e, o + 1))
  ...
  static async CreateCharacterRequest() {
    ...
    let o = ModelManager_1.ModelManager.LoginModel.GetPlayerName();
    let r = new Protocol_1.Aki.Protocol.cis();
    var e =
      ((r.x6n = e),
      (r.e4n = o),
      Log_1.Log.CheckInfo() &&
  ...
  static kvi() {
    let e;
    let o;
    const r = ModelManager_1.ModelManager.LoginModel.GetLastLoginTime();
    return (
  ...
  static jvi() {
    const e = new LoginModel_1.LoginNotice();
    (e.Title =
  ...
  static LogLoginProcessLink(e, o = Protocol_1.Aki.Protocol.lkn.Sys) {
    const r = ModelManager_1.ModelManager.LoginModel.GetSdkLoginConfig();
    const n = new LogReportDefine_1.LoginProcessLink();
...
(exports.LoginController = LoginController),
  ...
  (LoginController.OnLogoutAccount = () => {
    const e = ModelManager_1.ModelManager.LoginModel.GetSdkLoginState();
    ModelManager_1.ModelManager.LoginModel.SetSdkLoginState(0),
      ModelManager_1.ModelManager.LoginModel.GetLoginStatus() >=
        LoginDefine_1.ELoginStatus.EnterGameRet && e !== 0
        ? ControllerHolder_1.ControllerHolder.ReConnectController.Logout(
  ...
  (LoginController.C9s = () => {
    const e = ModelManager_1.ModelManager.LoginModel;
    const o = Protocol_1.Aki.Protocol.s7s.create();
    (o.h6n = UE.KuroLauncherLibrary.GetAppVersion()),
  ...
  (LoginController.i9s = () => {
    ...
    const o = new ConfirmBoxDefine_1.ConfirmBoxDataNew(10);
    o.SetTextArgs(e);
    o.FunctionMap.set(1, () => {
      ControllerHolder_1.ControllerHolder.ReConnectController.Logout(
        ReconnectDefine_1.ELogoutReason.LogoutNotify,

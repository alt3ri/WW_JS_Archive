...
class PersonalCardComponent extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    (this.ComponentRegisterInfos = [
      ...
      this.L0 || (this.BtnBindInfo = [[7, this.qha]]);
  }
  OnStart() {
  ...
  async OnBeforeShowAsyncImplement() {
    var e = this.p5i.GetCardList(!0);
    if ((await this.xqe.RefreshByDataAsync(e), 0 < e.length)) {
  ...
  uGe(e) {
    var t = this.p5i.CurCardId,
      i = e.IsUnLock,
      i = t !== e.CardId && i;
    this.P7e && this.P7e(i, t === e.CardId);
  }
  OnBeforeDestroy() {

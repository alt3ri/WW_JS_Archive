...
class UiCameraStructure {
  ...
  Activate() {
    Log_1.Log.CheckInfo() &&
      Log_1.Log.Info("UiCamera", 58, "激活相机结构", [
        "Name",
  ...
  Deactivate() {
    Log_1.Log.CheckInfo() &&
      Log_1.Log.Info("UiCamera", 58, "休眠相机结构", [
        "Name",
        this.constructor.name,
      ]),
      this.OnDeactivate();
  ...
  OnSpawnStructureActor() {
    Log_1.Log.CheckError() &&
      Log_1.Log.Error("UiCamera", 58, "没有创建StructureActor", [
        "Name",
        this.constructor.name,
      ]);
  }
  OnSetSpringArmComponent() {
    Log_1.Log.CheckError() &&
      Log_1.Log.Error("UiCamera", 58, "没有实现OnSetSpringArmComponent", [
        "Name",
        this.constructor.name,
      ]);
  }
  ...
  AttachToComponent(t, i = FNameUtil_1.FNameUtil.NONE, e = 2, o = 2, r = 1) {
    this.CameraActor?.IsValid() &&
      this.CameraActor.K2_AttachToComponent(t, i, e, o, r, !1);
  }
  ...
  SetActorLocation(t) {
    this.OwnActor.D_K2_GetActorLocation().Equals(
      t,
      MathUtils_1.MathUtils.SmallNumber,
    ) || this.OwnActor.D_K2_SetActorLocation(t, !1, void 0, !1);
  }
  SetActorRelativeLocation(t) {
    void 0 !== this.OwnActor.GetParentComponent()
      ? this.OwnActor.D_K2_SetActorRelativeLocation(t, !1, void 0, !1)
      : this.OwnActor.D_K2_SetActorLocation(t, !1, void 0, !1);
  }

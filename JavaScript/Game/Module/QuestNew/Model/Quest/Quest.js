...
class Quest extends LogicTreeContainer_1.LogicTreeContainer {
  constructor(t, e) {
    super(),
      ...
      (this.AutoTrack = !1),
      (this.AutoCoverCurTrack = !1),
      (this.AutoHideTrackMark = !0),
      (this.IsSecretQuest = !1),
      (this.DungeonId = 0),
      (this.FunctionId = 0),
      (this.TagId = 0),
      ...
      e
        ? ((this.InnerId = e.Id),
          ...
          (this.AutoTrack = e.IsAutoTrack ?? !1),
          (this.AutoCoverCurTrack = e.IsAutoCoverCurTrack ?? !1),
          (this.Yro = e.RecommendPreQuest),
          (this.TagId = e.TagId ?? 0),
          (this.IsSecretQuest = e.IsHideInTaskList ?? !1),
  ...
  get NameKey() {
    let t = this.Qro;
    return (t = void 0 !== t && 0 !== t.length ? t : this.uno);
  }
  get Name() {
    ...
    if (i) {
      switch (t) {
        ...
        case Protocol_1.Aki.Protocol.hTs.nvs:
          (this.IsNewQuest = 1 === e), this.OnQuestToProgress();
          break;
    ...
    switch (this.DistributeType) {
      ...
      default:
        Log_1.Log.CheckDebug() &&
          Log_1.Log.Debug("Quest", 26, "未支持的任务派发类型：", [
            "this.DistributeType",
            this.DistributeType,
          ]);
    }
  ...
  AddAcceptQuestMark() {
    ...
    this.HideAcceptQuestMark ||
      ((t = this.AcceptQuestOptionConfig)
        ...
        : Log_1.Log.CheckError() &&
          Log_1.Log.Error("Quest", 18, "交互接取的任务没有配交互选项", [
            "任务Id",
            this.Id,
          ]));
  }
  ...
  Zro(t, e) {
    ModelManager_1.ModelManager.CreatureModel.GetEntityData(t, e)
      ? (e = this.QuestMarkId) &&
        ...
        ((e = new MapDefine_1.QuestMarkCreateInfo({
          ...
          NodeId: 0,
          EntityConfigId: t,
          MapAndDungeonInfo: { DungeonId: this.DungeonId },
        })),

...
class ActivityTitleTypeA extends UiPanelBase_1.UiPanelBase {
  ...
  SetTimeTextByTextId(t, ...e) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t, e);
  }
  SetBgTextureByPath(t, e) {
    this.SetTextureByPath(t, this.GetTexture(2), void 0, e);
  }
  ...
  SetSubTitleIconByPath(t, e) {
    this.SetSpriteByPath(t, this.GetSprite(4), !1, void 0, e);
  }
}

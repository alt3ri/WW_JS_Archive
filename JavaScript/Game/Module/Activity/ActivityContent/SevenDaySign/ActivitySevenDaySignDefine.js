...
class ImportantRewardItem extends (exports.SignRewardItemBase =
  ...
  RefreshByData(t, e, i) {
    ...
    const s = e === Protocol_1.Aki.Protocol.D0s.j0s;
    const r = ((this.CanGetReward = s), this.GetText(4));
    var e =
      (r?.SetChangeColor(e === Protocol_1.Aki.Protocol.D0s.h3n, r.changeColor),
...
class NormalRewardItem extends SignRewardItemBase {
  ...
  RefreshByData(t, e, i) {
    ...
    var i = e === Protocol_1.Aki.Protocol.D0s.qms;
    const s = e === Protocol_1.Aki.Protocol.D0s.j0s;
    var r = ((this.CanGetReward = s), this.GetText(2));
    var r =
      (r?.SetChangeColor(e === Protocol_1.Aki.Protocol.D0s.h3n, r.changeColor),
      ...
      ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(
        s ? "SP_NewSignInSmallItemBg_Reward" : "SP_NewSignInSmallItemBg_Normal",
      ));
  ...
  cNe(t, e) {
    ...
    const r = e === Protocol_1.Aki.Protocol.D0s.j0s;
    const o = e === Protocol_1.Aki.Protocol.D0s.h3n;
    const a = e === Protocol_1.Aki.Protocol.D0s.qms;
    switch (s) {
      case 1:
  ...
  cNe(t, e) {
    ...
    const r =
      ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(this.Mne)
        ?.QualityId ?? 1;
    const o = e === Protocol_1.Aki.Protocol.D0s.j0s;
    const a = e === Protocol_1.Aki.Protocol.D0s.h3n;
    const h = e === Protocol_1.Aki.Protocol.D0s.qms;
    switch (s) {
      case 1:

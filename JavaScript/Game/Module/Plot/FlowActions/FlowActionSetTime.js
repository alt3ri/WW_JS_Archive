...
class FlowActionSetTime extends FlowActionBase_1.FlowActionBase {
  OnExecute() {
    ...
    var e = TimeOfDayModel_1.TodDayTime.ConvertFromHourMinute(e.Hour, e.Min);
    e < 0 || ModelManager_1.ModelManager.PlotModel.PlotTimeOfDay.SetTime(e);
  }
  OnBackgroundExecute() {
    this.OnExecute();
  }
...
// # sourceMappingURL=FlowActionSetTime.js.map

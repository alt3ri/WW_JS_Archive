...
class SilentAreaView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments),
      ...
      (this.N6e = (e, i) => {
        ...
        var e = ((this.b6e = e), this.GetText(2));
        let r = this.GetText(1);
        let t = i.Conf.Name;
  ...
  OnStart() {
    (this.TVe = new LoopScrollView_1.LoopScrollView(
      ...
      () => {
        const e = new SilentAreaItem_1.SilentAreaItem();
    ...
    let i = e[0] === "DisposableChallengeView" ? e[1] : void 0;
    let r =
  ...
  BuildRewardList(e) {
    ...
    for (const o of i.keys()) {
      const t = { Id: o, Num: i.get(o), Received: !1 };
      r.push(t);
    }

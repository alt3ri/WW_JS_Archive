...
class OperationsPerformance {
  ...
  static k3i(e) {
    if (e <= 0) return 0;
    if (JankStatisticsCycle.IsReady() && 2 * JankStatisticsCycle.GetAvg() < e)
      return OperationsPerformance.F3i++, BIG_JANK_TYPE;
    return (
      JankStatisticsCycle.AddStatisticsNumber(e),
      e > OperationsPerformance.V3i
        ? (OperationsPerformance.H3i++, SMALL_JANK_TYPE)
        : 0
    );
  }
  static j3i(e) {

...
class ExploreLevelController extends UiControllerBase_1.UiControllerBase {
  static OnRegisterNetEvent() {
    Net_1.Net.Register(15784, ExploreLevelController.lVt);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(15784);
  }
  static ExploreScoreRewardRequest(e, o) {
    ...
    (r.p6n = e),
      ...
      Net_1.Net.Call(24897, r, this._Vt);
  }
  ...
  static async CountryExploreScoreInfoAsyncRequest(e) {
    var o = new Protocol_1.Aki.Protocol.lts(),
      o =
        ...
        await Net_1.Net.CallAsync(21358, o));
    if (o) {
      Log_1.Log.CheckInfo() &&
        Log_1.Log.Info(
          "ExploreLevel",

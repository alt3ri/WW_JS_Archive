...
const __decorate =
  ...
  function (e, i, t, o) {
    ...
    let n =
      r < 3 ? i : o === null ? (o = Object.getOwnPropertyDescriptor(i, t)) : o;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
      n = Reflect.decorate(e, i, t, o);
    else
      for (let h = e.length - 1; h >= 0; h--)
        (s = e[h]) && (n = (r < 3 ? s(n) : r > 3 ? s(i, t, n) : s(i, t)) || n);
...
let UiModelLoadComponent = class UiModelLoadComponent extends UiModelComponentBase_1.UiModelComponentBase {
  ...
  GetChildMeshPathList() {
    const i = ModelUtil_1.ModelUtil.GetModelConfig(
      this.UiModelDataComponent.ModelConfigId,
    ).子网格体;
    if (i) {
      const t = i.Num();
  ...
  LoadModel(h) {
    this.UiModelDataComponent?.GetModelLoadState() === 1 &&
    ...
    const l = this.GetAnimClassPath();
    const d = this.GetChildMeshPathList();
    const e = [];
    if (
    ...
    this.LoadHandleId =
      UiModelResourcesManager_1.UiModelResourcesManager.LoadUiModelResources(
        ...
        (e, i) => {
          ...
          const t = UE.NewArray(UE.SkeletalMesh);
          const o = this.GetLoadedResource(a);
          var i = (t.Add(o), this.GetLoadedResource(l));
          let s = void 0;
          if (d) {
            s = [];
            for (const n of d) {
              const r = this.GetLoadedResource(n);
              s.push(r), t.Add(o);
            }
          }
  ...
  FinishLoad() {
    ...
    const e = this.UiModelDataComponent?.GetDitherEffectValue() ?? 1;

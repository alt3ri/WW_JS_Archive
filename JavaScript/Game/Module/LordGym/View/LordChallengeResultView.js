...
class LordChallengeResultView extends UiViewBase_1.UiViewBase {
  ...
  async G2e() {
    ...
    var e = this.k2e(this.GetItem(5), CLOSE_BUTTON_KEY, e, this.q2e);
    var e =
      (i.push(e),
  ...
  $2e() {
    let e = void 0 !== this.B2e.PassTime;
  ...
  O2e() {
    ...
    const s = e ? SUCCESS_OUTLINE_COLOR : FAIL_OUTLINE_COLOR;
    var e = e

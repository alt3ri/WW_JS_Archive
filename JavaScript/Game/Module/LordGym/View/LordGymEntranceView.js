...
class LordGymEntranceView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments),
      ...
      (this.ZSi = () => {
        this.O3e > 0 && HelpController_1.HelpController.OpenHelpById(this.O3e);
      }),
      (this.eEi = () => {
      ...
      (this.JSi = (e) => {
        ...
        const t = i?.GetLayoutItemByKey(this.KSi);
        var i =
        ...
        const o = ModelManager_1.ModelManager.LordGymModel.GetLastGymFinish(
          this.KSi,
        );
        const a = i.MonsterLevel > this.oEi();
  ...
  nEi() {
    ...
    const e = this.$Si?.GetGenericLayout();
    const i = e?.GetLayoutItemByKey(this.XSi);

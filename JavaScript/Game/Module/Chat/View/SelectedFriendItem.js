...
class SelectedFriendItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Zke() {
    ...
    var t = ModelManager_1.ModelManager.PersonalModel.GetPlayerHeadData(e, !1);
    t
      ? (i.SetUIActive(!1),
        this.SetTextureShowUntilLoaded(t.GetRoleHeadIcon(), i, () => {
          i.SetUIActive(!0);
        }))
  ...
  Hmc() {
    this.gLt?.Refresh(
      this.pSt.PlayerTitleId,
      this.pSt.PlayerTitleStarLevel,
      this.pSt.PlayerSex,
    );
  }
}

...
class ChatController extends UiControllerBase_1.UiControllerBase {
  ...
  static async E$a(e, t, a) {
    var o =
      ...
      r = [];
    for (const n of t) (o && o.get(n.zih)) || r.push(n);
  ...
  static async I$a(e) {
    ...
    for (const C of e.bLs) {
      var r = C.B8n,
        ...
        o = [];
      for (const g of C.ULs) (t && t.get(g.zih)) || o.push(g);
  ...
  static async Kza(e) {
    var t = new Array();
    for (const v of e.VLs) "" === v.zih || t.includes(v.zih) || t.push(v.zih);
    let a = new Map();
    0 < t.length &&
      (a =
        await PlatformSdkManagerNew_1.PlatformSdkManagerNew.GetPlatformSdk()?.GetTargetRelation(

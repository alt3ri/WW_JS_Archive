...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.FbAdjustDialogCamera = void 0);
...
class FbAdjustDialogCamera {
  ...
  static Create(t) {
    if (t) return new FbAdjustDialogCamera(t);
  }
  get Type() {
    return (
  ...
  get YawAngle() {
    return (
      this.gTh ||
        ((this.gTh = !0), (this.fTh = this.FbDataInternal.yawAngle())),
      this.fTh
    );
  }
  get PitchAngle() {
    return (
      this.pTh ||
        ((this.pTh = !0), (this.vTh = this.FbDataInternal.pitchAngle())),
      this.vTh
    );
  }
  get CenterPos() {
...
exports.FbAdjustDialogCamera = FbAdjustDialogCamera;
//# sourceMappingURL=FbAdjustDialogCamera.js.map

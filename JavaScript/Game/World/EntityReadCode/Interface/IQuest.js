...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  ...
  (function (e) {
    (e.LevelPlay = "LevelPlay"),
      (e.BossRushBuffInfo = "BossRushBuffInfo"),
      (e.DangoAbyss = "DangoAbyss");
  })(
    (EInformationViewType =
      exports.EInformationViewType || (exports.EInformationViewType = {})),
  ),
  ((EInformationBoardType =
    exports.EInformationBoardType ||
    (exports.EInformationBoardType = {})).DangoAbyss = "DangoAbyss"),
  ((ESpecialGamePlayConfigType =
    exports.ESpecialGamePlayConfigType ||
...
(exports.childQuestForQuest = new Set(childQuestAll)),
  ...
  (exports.questSubTypeCnMapper = { [1]: "2.3团子活动任务" }),
  (exports.questSubTypeBinding = new Map([[10, new Set([1])]])),
...
function flatNode(t, o, e) {
  switch ((o.set(t.Id, { ...t, ParentNodeId: e?.Id }), t.Type)) {
    case "Start":
    case "AlwaysTrue":
    case "AlwaysFalse":
    case "Repeater":
      t.Child && flatNode(t.Child, o, t);
      break;
    case "Action":
    case "QuestSucceed":
    case "QuestFailed":

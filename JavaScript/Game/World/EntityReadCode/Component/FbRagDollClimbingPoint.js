...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.FbRagDollClimbingPoint = void 0);
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action"),
  FbActionInfo_1 = require("../Action/FbActionInfo");
class FbRagDollClimbingPoint {
  constructor(t) {
  ...
  static Create(t) {
    if (t) return new FbRagDollClimbingPoint(t);
  }
  get Type() {
    return (
  ...
  get IsSummitPoint() {
    return (
      this.NGh ||
        ((this.NGh = !0), (this.VGh = this.FbDataInternal.isSummitPoint())),
      this.VGh
    );
  }
}
exports.FbRagDollClimbingPoint = FbRagDollClimbingPoint;
//# sourceMappingURL=FbRagDollClimbingPoint.js.map

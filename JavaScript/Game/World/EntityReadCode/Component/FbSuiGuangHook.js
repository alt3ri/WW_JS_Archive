...
class FbSuiGuangHook {
  ...
  static Create(t) {
    if (t) return new FbSuiGuangHook(t);
  }
  get Type() {
    return (
...
exports.FbSuiGuangHook = FbSuiGuangHook;
//# sourceMappingURL=FbSuiGuangHook.js.map

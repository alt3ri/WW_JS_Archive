...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.CheckTeleControlState = void 0);
...
class CheckTeleControlState {
  ...
  static getRootAsCheckTeleControlState(t, e) {
    return (e || new CheckTeleControlState()).__init(
  ...
  static getSizePrefixedRootAsCheckTeleControlState(t, e) {
    return (
      ...
      (e || new CheckTeleControlState()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createCheckTeleControlState(t, e, r, s, o) {
    return (
      ...
      CheckTeleControlState.endCheckTeleControlState(t)
    );
  }
}

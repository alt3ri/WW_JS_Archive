...
class AdjustHorizontalCamera {
  ...
  static getRootAsAdjustHorizontalCamera(t, i) {
    return (i || new AdjustHorizontalCamera()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsAdjustHorizontalCamera(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new AdjustHorizontalCamera()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  depthOfField(t) {
    ...
    return i
      ? (t || new camera_depth_of_field_js_1.CameraDepthOfField()).__init(
          this.bb.__indirect(this.bb_pos + i),
          this.bb,
        )
      : void 0;
  }
  static startAdjustHorizontalCamera(t) {
    t.startObject(19);
  }
  static addType(t, i) {
  ...
  static addPitchAngle(t, i) {
    t.addFieldFloat32(17, i, 0);
  }
  static addDepthOfField(t, i) {
    t.addFieldOffset(18, i, 0);
  }
  static endAdjustHorizontalCamera(t) {
    return t.endObject();
  }
}

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.EnableAllPlayerOperation = void 0);
...
class EnableAllPlayerOperation {
  ...
  static getRootAsEnableAllPlayerOperation(e, t) {
    return (t || new EnableAllPlayerOperation()).__init(
  ...
  static getSizePrefixedRootAsEnableAllPlayerOperation(e, t) {
    return (
      ...
      (t || new EnableAllPlayerOperation()).__init(
        e.readInt32(e.position()) + e.position(),
        e,
      )
    );
  ...
  static createEnableAllPlayerOperation(e, t) {
    return (
      ...
      EnableAllPlayerOperation.endEnableAllPlayerOperation(e)
    );
  }
}

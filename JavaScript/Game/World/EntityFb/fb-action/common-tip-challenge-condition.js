...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.CommonTipChallengeCondition = void 0);
...
class CommonTipChallengeCondition {
  ...
  static getRootAsCommonTipChallengeCondition(i, t) {
    return (t || new CommonTipChallengeCondition()).__init(
  ...
  static getSizePrefixedRootAsCommonTipChallengeCondition(i, t) {
    return (
      ...
      (t || new CommonTipChallengeCondition()).__init(
        i.readInt32(i.position()) + i.position(),
        i,
      )
    );
  ...
  static createCommonTipChallengeCondition(i, t, n, o) {
    return (
      ...
      CommonTipChallengeCondition.endCommonTipChallengeCondition(i)
    );
  }
}

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.PerformerAiMoveToEntity = void 0);
...
class PerformerAiMoveToEntity {
  ...
  static getRootAsPerformerAiMoveToEntity(t, e) {
    return (e || new PerformerAiMoveToEntity()).__init(
  ...
  static getSizePrefixedRootAsPerformerAiMoveToEntity(t, e) {
    return (
      ...
      (e || new PerformerAiMoveToEntity()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createPerformerAiMoveToEntity(t, e, r) {
    return (
      ...
      PerformerAiMoveToEntity.endPerformerAiMoveToEntity(t)
    );
  }
}

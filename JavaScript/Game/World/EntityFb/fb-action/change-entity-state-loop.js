...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.ChangeEntityStateLoop = void 0);
...
class ChangeEntityStateLoop {
  ...
  static getRootAsChangeEntityStateLoop(t, e) {
    return (e || new ChangeEntityStateLoop()).__init(
  ...
  static getSizePrefixedRootAsChangeEntityStateLoop(t, e) {
    return (
      ...
      (e || new ChangeEntityStateLoop()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createChangeEntityStateLoop(t, e, i, a) {
    return (
      ...
      ChangeEntityStateLoop.endChangeEntityStateLoop(t)
    );
  }
}

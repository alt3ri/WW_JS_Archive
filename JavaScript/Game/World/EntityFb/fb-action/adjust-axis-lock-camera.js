...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.AdjustAxisLockCamera = void 0);
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers"),
  axis_lock_screen_config_js_1 = require("../fb-action/axis-lock-screen-config.js"),
...
class AdjustAxisLockCamera {
  ...
  static getRootAsAdjustAxisLockCamera(t, i) {
    return (i || new AdjustAxisLockCamera()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsAdjustAxisLockCamera(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new AdjustAxisLockCamera()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  screenConfig(t) {
    ...
    return i
      ? (t || new axis_lock_screen_config_js_1.AxisLockScreenConfig()).__init(
          this.bb.__indirect(this.bb_pos + i),
          this.bb,
        )
      : void 0;
  }
  static startAdjustAxisLockCamera(t) {
    t.startObject(17);
  }
  static addType(t, i) {
  ...
  static addAxisRotate(t, i) {
    t.addFieldOffset(15, i, 0);
  }
  static addScreenConfig(t, i) {
    t.addFieldOffset(16, i, 0);
  }
  static endAdjustAxisLockCamera(t) {
    return t.endObject();
  }
}

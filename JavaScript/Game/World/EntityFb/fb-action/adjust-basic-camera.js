...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.AdjustBasicCamera = void 0);
...
class AdjustBasicCamera {
  ...
  static getRootAsAdjustBasicCamera(t, i) {
    return (i || new AdjustBasicCamera()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsAdjustBasicCamera(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new AdjustBasicCamera()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static startAdjustBasicCamera(t) {
    t.startObject(18);
  }
  static addType(t, i) {
  ...
  static addOverlayArmLength(t, i) {
    t.addFieldFloat32(15, i, 0);
  }
  static addSightUi(t, i) {
    t.addFieldOffset(16, i, 0);
  }
  static addIsSynchronous(t, i) {
    t.addFieldInt8(17, +i, 0);
  }
  static endAdjustBasicCamera(t) {
    return t.endObject();
  }
}
exports.AdjustBasicCamera = AdjustBasicCamera;
//# sourceMappingURL=adjust-basic-camera.js.map

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.NpcNewSplineMoveTarget = void 0);
...
class NpcNewSplineMoveTarget {
  ...
  static getRootAsNpcNewSplineMoveTarget(e, t) {
    return (t || new NpcNewSplineMoveTarget()).__init(
  ...
  static getSizePrefixedRootAsNpcNewSplineMoveTarget(e, t) {
    return (
      ...
      (t || new NpcNewSplineMoveTarget()).__init(
        e.readInt32(e.position()) + e.position(),
        e,
      )
    );
  ...
  static createNpcNewSplineMoveTarget(e, t, i) {
    return (
      ...
      NpcNewSplineMoveTarget.endNpcNewSplineMoveTarget(e)
    );
  }
}

...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.ResetTeleControlEntity = void 0);
...
class ResetTeleControlEntity {
  ...
  static getRootAsResetTeleControlEntity(t, e) {
    return (e || new ResetTeleControlEntity()).__init(
  ...
  static getSizePrefixedRootAsResetTeleControlEntity(t, e) {
    return (
      ...
      (e || new ResetTeleControlEntity()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createResetTeleControlEntity(t, e, s) {
    return (
      ...
      ResetTeleControlEntity.endResetTeleControlEntity(t)
    );
  }
}

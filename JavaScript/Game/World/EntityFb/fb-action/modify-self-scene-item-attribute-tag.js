...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.ModifySelfSceneItemAttributeTag = void 0);
...
class ModifySelfSceneItemAttributeTag {
  ...
  static getRootAsModifySelfSceneItemAttributeTag(t, e) {
    return (e || new ModifySelfSceneItemAttributeTag()).__init(
  ...
  static getSizePrefixedRootAsModifySelfSceneItemAttributeTag(t, e) {
    return (
      ...
      (e || new ModifySelfSceneItemAttributeTag()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createModifySelfSceneItemAttributeTag(t, e, i, r) {
    return (
      ...
      ModifySelfSceneItemAttributeTag.endModifySelfSceneItemAttributeTag(t)
    );
  }
}

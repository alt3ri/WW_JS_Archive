...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.SetPlayerOperationRestriction = void 0);
...
class SetPlayerOperationRestriction {
  ...
  static getRootAsSetPlayerOperationRestriction(t, e) {
    return (e || new SetPlayerOperationRestriction()).__init(
  ...
  static getSizePrefixedRootAsSetPlayerOperationRestriction(t, e) {
    return (
      ...
      (e || new SetPlayerOperationRestriction()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createSetPlayerOperationRestriction(t, e) {
    return (
      ...
      SetPlayerOperationRestriction.endSetPlayerOperationRestriction(t)
    );
  }
}

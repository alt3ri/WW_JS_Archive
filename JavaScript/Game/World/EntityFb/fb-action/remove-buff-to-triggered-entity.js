...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.RemoveBuffToTriggeredEntity = void 0);
...
class RemoveBuffToTriggeredEntity {
  ...
  static getRootAsRemoveBuffToTriggeredEntity(t, e) {
    return (e || new RemoveBuffToTriggeredEntity()).__init(
  ...
  static getSizePrefixedRootAsRemoveBuffToTriggeredEntity(t, e) {
    return (
      ...
      (e || new RemoveBuffToTriggeredEntity()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createRemoveBuffToTriggeredEntity(t, e) {
    return (
      ...
      RemoveBuffToTriggeredEntity.endRemoveBuffToTriggeredEntity(t)
    );
  }
}

...
class AdjustFixedCamera {
  ...
  static getRootAsAdjustFixedCamera(t, i) {
    return (i || new AdjustFixedCamera()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsAdjustFixedCamera(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new AdjustFixedCamera()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  blendIn(t) {
    ...
    return i
      ? (t || new blend_function_js_1.BlendFunction()).__init(
          this.bb.__indirect(this.bb_pos + i),
          this.bb,
        )
      : void 0;
  ...
  static startAdjustFixedCamera(t) {
    t.startObject(19);
  }
  static addType(t, i) {
  ...
  static addCenterRot(t, i) {
    t.addFieldOffset(16, i, 0);
  }
  static addBlendIn(t, i) {
    t.addFieldOffset(17, i, 0);
  }
  static addBlendOut(t, i) {
    t.addFieldOffset(18, i, 0);
  }
  static endAdjustFixedCamera(t) {
    return t.endObject();
  }
}
exports.AdjustFixedCamera = AdjustFixedCamera;
//# sourceMappingURL=adjust-fixed-camera.js.map

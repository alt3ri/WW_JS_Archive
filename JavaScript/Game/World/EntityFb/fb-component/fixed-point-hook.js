...
class FixedPointHook {
  ...
  static getRootAsFixedPointHook(t, i) {
    return (i || new FixedPointHook()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsFixedPointHook(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new FixedPointHook()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static endFixedPointHook(t) {
    return t.endObject();
  }
  static createFixedPointHook(t, i, o, s, e) {
    return (
      FixedPointHook.startFixedPointHook(t),
      FixedPointHook.addType(t, i),
      FixedPointHook.addHookActions(t, o),
      FixedPointHook.addExitHookActions(t, s),
      FixedPointHook.addFinishActions(t, e),
      FixedPointHook.endFixedPointHook(t)
    );
  }
}
exports.FixedPointHook = FixedPointHook;
//# sourceMappingURL=fixed-point-hook.js.map

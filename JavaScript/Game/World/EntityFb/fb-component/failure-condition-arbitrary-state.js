...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.FailureConditionArbitraryState = void 0);
...
class FailureConditionArbitraryState {
  ...
  static getRootAsFailureConditionArbitraryState(t, i) {
    return (i || new FailureConditionArbitraryState()).__init(
  ...
  static getSizePrefixedRootAsFailureConditionArbitraryState(t, i) {
    return (
      ...
      (i || new FailureConditionArbitraryState()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createFailureConditionArbitraryState(t, i, r) {
    return (
      ...
      FailureConditionArbitraryState.endFailureConditionArbitraryState(t)
    );
  }
}

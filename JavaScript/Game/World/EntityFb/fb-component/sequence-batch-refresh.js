...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.SequenceBatchRefresh = void 0);
...
class SequenceBatchRefresh {
  ...
  static getRootAsSequenceBatchRefresh(t, e) {
    return (e || new SequenceBatchRefresh()).__init(
  ...
  static getSizePrefixedRootAsSequenceBatchRefresh(t, e) {
    return (
      ...
      (e || new SequenceBatchRefresh()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createSequenceBatchRefresh(t, e, s, h, r) {
    return (
      ...
      SequenceBatchRefresh.endSequenceBatchRefresh(t)
    );
  }
}

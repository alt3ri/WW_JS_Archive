...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.EntityMatchAllCharacter = void 0);
...
class EntityMatchAllCharacter {
  ...
  static getRootAsEntityMatchAllCharacter(t, a) {
    return (a || new EntityMatchAllCharacter()).__init(
  ...
  static getSizePrefixedRootAsEntityMatchAllCharacter(t, a) {
    return (
      ...
      (a || new EntityMatchAllCharacter()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static createEntityMatchAllCharacter(t, a) {
    return (
      ...
      EntityMatchAllCharacter.endEntityMatchAllCharacter(t)
    );
  }
}

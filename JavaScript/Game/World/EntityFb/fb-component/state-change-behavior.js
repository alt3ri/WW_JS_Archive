...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.StateChangeBehavior = void 0);
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers"),
  ...
  delay_change_state_js_1 = require("../fb-component/delay-change-state.js");
class StateChangeBehavior {
  ...
  static getRootAsStateChangeBehavior(t, i) {
    return (i || new StateChangeBehavior()).__init(
  ...
  static getSizePrefixedRootAsStateChangeBehavior(t, i) {
    return (
      ...
      (i || new StateChangeBehavior()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  delayChangeState(t) {
    ...
    return i
      ? (t || new delay_change_state_js_1.DelayChangeState()).__init(

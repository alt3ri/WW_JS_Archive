...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.PullingCategoryMatchingFoundation = void 0);
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers"),
  category_matching_config_base_js_1 = require("../fb-component/category-matching-config-base.js");
class PullingCategoryMatchingFoundation {
  ...
  static getRootAsPullingCategoryMatchingFoundation(t, i) {
    return (i || new PullingCategoryMatchingFoundation()).__init(
  ...
  static getSizePrefixedRootAsPullingCategoryMatchingFoundation(t, i) {
    return (
      ...
      (i || new PullingCategoryMatchingFoundation()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  matchingConfigs(t, i) {
    ...
    return n
      ? (
          i ||
          new category_matching_config_base_js_1.CategoryMatchingConfigBase()
        ).__init(
  ...
  static createPullingCategoryMatchingFoundation(t, i, n, a) {
    return (
      PullingCategoryMatchingFoundation.startPullingCategoryMatchingFoundation(
        t,
      ),
      ...
      PullingCategoryMatchingFoundation.endPullingCategoryMatchingFoundation(t)
    );
  }
}

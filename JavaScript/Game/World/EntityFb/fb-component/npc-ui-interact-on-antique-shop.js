...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.NpcUiInteractOnAntiqueShop = void 0);
...
class NpcUiInteractOnAntiqueShop {
  constructor() {
  ...
  static getRootAsNpcUiInteractOnAntiqueShop(t, i) {
    return (i || new NpcUiInteractOnAntiqueShop()).__init(
      t.readInt32(t.position()) + t.position(),
      t,
    );
  }
  static getSizePrefixedRootAsNpcUiInteractOnAntiqueShop(t, i) {
    return (
      t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH),
      (i || new NpcUiInteractOnAntiqueShop()).__init(
        t.readInt32(t.position()) + t.position(),
        t,
      )
    );
  ...
  static startNpcUiInteractOnAntiqueShop(t) {
    t.startObject(11);
  }
  static addType(t, i) {
  ...
  static endNpcUiInteractOnAntiqueShop(t) {
    return t.endObject();
  }
}
exports.NpcUiInteractOnAntiqueShop = NpcUiInteractOnAntiqueShop;
//# sourceMappingURL=npc-ui-interact-on-antique-shop.js.map

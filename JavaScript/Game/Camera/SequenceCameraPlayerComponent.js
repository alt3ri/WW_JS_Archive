...
let SequenceCameraPlayerComponent = class SequenceCameraPlayerComponent extends EntityComponent_1.EntityComponent {
  ...
  OnAfterTick(t) {
    ...
    this.Ixr && this.rRe && this.Txr
      ...
      : this.yxr &&
        ((this.yxr = Math.max(
          0,
          this.yxr - t * MathUtils_1.MathUtils.MillisecondToSecond,
        )),
  ...
  GQe(t) {
    if (((this.Rxr = t.IsHideHud), this.Rxr)) {
      ...
      if (i <= 0)
        ...
        var s = [];
        for (let t = 0; t < i; t++) s.push(e.Get(t));
        ModelManager_1.ModelManager.BattleUiModel.ChildViewData.HideBattleView(
          2,
          s,
        );
  ...
  S9e(t, e) {
    let i = !1;
    return (
      (t || (!this.awr(e) && !this.CheckSphereCollision())) && this.hwr()
        ? (this.lwr(), (i = !0))
        : this.Zxr(),
      i
    );

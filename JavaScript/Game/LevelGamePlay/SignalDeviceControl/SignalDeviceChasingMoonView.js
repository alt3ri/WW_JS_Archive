...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.SignalDeviceChasingMoonView = void 0);
const UE = require("ue"),
...
class SignalDeviceChasingMoonView extends UiViewBase_1.UiViewBase {
  ...
  async OnCreateAsync() {
    (this.WAe = new LinkingDotItem_1.LinkingDotItem()),
      ...
      await Promise.all([
        this.WAe.CreateThenShowByResourceIdAsync("UiItem_LinkingDotCM"),
        this.EPe.CreateThenShowByResourceIdAsync("UiItem_LinkLineACM"),
        this.pPe.CreateThenShowByResourceIdAsync("UiItem_LinkLineBCM"),
        this.fPe.CreateThenShowByResourceIdAsync("UiItem_LinkLineCCM"),
        this.MPe.CreateThenShowByResourceIdAsync("UiItem_LinkLineECM"),
        this.vPe.CreateThenShowByResourceIdAsync("UiItem_LinkLineDCM"),
      ]);
  }
  OnStart() {

...
class BinItem {
  ...
  zwe(t) {
    ...
    for (let t = 0, e = r; t < e; t++) {
      const s = i.GetWorldLocationAtSplinePoint(t);
  ...
  BinTest(t) {
    const e = new Vector2D_1.Vector2D(t.X, t.Y);
    var t = this.BinSet;
    const r = this.TestPoints;
    if (e.Y < t.MinY || e.Y >= t.MaxY || e.X < t.MinX || e.X >= t.MaxX)
      return !1;
    const i = Math.floor((e.Y - t.MinY) * t.ReciprocalDeltaY);
    var t = t.Bins[i];
  ...
  Zwe(e, t, o) {
    ...
    for (const h of e) {
      if (a.Y !== h.Y) {
        ...
        const s = Math.floor((_.Y - o.MinY) * o.ReciprocalDeltaY);
        const l = (n.Y - o.MinY) * o.ReciprocalDeltaY;
        let e = Math.floor(l);
        l - e == 0 && (e -= 1);
    ...
    for (let t = 0; t < e.length; t++) {
      if (((h = e[t]), a.Y !== h.Y)) {
        ...
        let M = (n.Y - o.MinY) * o.ReciprocalDeltaY;
        let e = Math.floor(M);
        let r = (M - e == 0 && (e -= 1), _.X);
        const g = (o.DeltaY * (n.X - _.X)) / (n.Y - _.Y);
        let i = r;
        let s = !1;
        for (let t = u; t < e; t++, r = i) {
          i = _.X + (t + 1 - p) * g;
          const L = o.Bins[t].Count;
          o.Bins[t].Count++,

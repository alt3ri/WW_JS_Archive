...
class LevelGeneralNetworks {
  ...
  static NQa(e) {
    var t = MathUtils_1.MathUtils.LongToNumber(e.Xih),
  ...
  static PushEntityTimeDilation(e, t) {
    var a = Protocol_1.Aki.Protocol.geh.create();
...
(exports.LevelGeneralNetworks = LevelGeneralNetworks),
  ...
  (LevelGeneralNetworks.GQa = (t) => {
    var e = MathUtils_1.MathUtils.LongToNumber(t.Xih),
  ...
  (LevelGeneralNetworks.uXa = (e) => {
    for (const t of e.KEs)
      t.h5n === Protocol_1.Aki.Protocol.toh.Proto_TeleportDungeon &&
  ...
  (LevelGeneralNetworks.hNa = (e) => {
    ...
    o &&
      ...
      (e = MathUtils_1.MathUtils.LongToNumber(e.trh)) &&

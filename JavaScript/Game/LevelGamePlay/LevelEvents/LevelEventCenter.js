...
const Log_1 = require("../../../Core/Common/Log"),
  ...
  LevelEventSetClientEntityVisibleSave_1 = require("../LevelConditions/LevelEventSetClientEntityVisibleSave"),
  ...
  LevelEventAddBuffToPlayer_1 = require("./LevelEventAddBuffToPlayer"),
  ...
  LevelEventChangeEntityState_1 = require("./LevelEventChangeEntityState"),
  LevelEventChangeSelfEntityState_1 = require("./LevelEventChangeSelfEntityState"),
  ...
  LevelEventClientSetPlayerPos_1 = require("./LevelEventClientSetPlayerPos"),
  LevelEventCollect_1 = require("./LevelEventCollect"),
  LevelEventCommonTip2_1 = require("./LevelEventCommonTip2"),
  ...
  LevelEventDestroySelf_1 = require("./LevelEventDestroySelf"),
  ...
  LevelEventEnterVehicleNpc_1 = require("./LevelEventEnterVehicleNpc"),
  LevelEventEntityLookAt_1 = require("./LevelEventEntityLookAt"),
  LevelEventEntityTurnTo_1 = require("./LevelEventEntityTurnTo"),
  ...
  LevelEventFakePlayerInput_1 = require("./LevelEventFakePlayerInput"),
  LevelEventFocusOnMapMark_1 = require("./LevelEventFocusOnMapMark"),
  ...
  LevelEventInteractGravityFlip_1 = require("./LevelEventInteractGravityFlip"),
  ...
  LevelEventLockEntity_1 = require("./LevelEventLockEntity"),
  ...
  LevelEventPlayGuestAnimation_1 = require("./LevelEventPlayGuestAnimation"),
  ...
  LevelEventPreloadRole_1 = require("./LevelEventPreloadRole"),
  ...
  LevelEventResetPlayerCameraFocus_1 = require("./LevelEventResetPlayerCameraFocus"),
  ...
  LevelEventRogueReceiveReward_1 = require("./LevelEventRogueReceiveReward"),
  ...
  LevelEventSetSubLevelsVisible_1 = require("./LevelEventSetSubLevelsVisible"),
  ...
  LevelEventSpawnEffectV2_1 = require("./LevelEventSpawnEffectV2"),
  ...
  LevelEventUnlockEntity_1 = require("./LevelEventUnlockEntity"),
  ...
  LevelEventVehicleMoveWithPathLine_1 = require("./LevelEventVehicleMoveWithPathLine"),
  LevelEventVehiclePlayPassengerVoice_1 = require("./LevelEventVehiclePlayPassengerVoice"),
  LevelEventVehicleSprint_1 = require("./LevelEventVehicleSprint"),
  LevelEventVehicleWaterfallMove_1 = require("./LevelEventVehicleWaterfallMove"),
...
class LevelEventCenter {
  ...
  static RegistEvents() {
    ...
    e("PlayerLookAt", LevelEventPlayerLoockAt_1.LevelEventPlayerLoockAt),
      ...
      e(
        "AddBuffToPlayer",
        LevelEventAddBuffToPlayer_1.LevelEventAddBuffToPlayer,
      ),
      e(
      ...
      e(
        ...
        LevelEventSetSubLevelsVisible_1.LevelEventSetSubLevelsVisible,
        LEVEL_1,
      ),
      e(
        "AdjustPlayerCamera",
      ...
      e(
        ...
        LevelEventResetPlayerCameraFocus_1.LevelEventResetPlayerCameraFocus,
      ),
      e(
        "UsePhantomSkill",
      ...
      e(
        "FocusOnMapMark",
        LevelEventFocusOnMapMark_1.LevelEventFocusOnMapMark,
        LEVEL_1,
      ),
      e(
        "SettlementDungeon",
      ...
      e("Preload", LevelEventPreloadRole_1.LevelEventPreloadRole),
      e(
        "RogueReceiveReward",
        LevelEventRogueReceiveReward_1.LevelEventRogueReceiveReward,
      ),
      e(
        "SetEntityClientVisibleSave",
        LevelEventSetClientEntityVisibleSave_1.LevelEventSetClientEntityVisibleSave,
      ),
      e(
        "EntityTurnTo",
        LevelEventEntityTurnTo_1.LevelEventEntityTurnTo,
        LEVEL_2,
      ),
      e(
        "GuestOperateUiAnimation",
        LevelEventPlayGuestAnimation_1.LevelEventGuestAnimation,
      ),
      e(
      ...
      e(
        "ClientSetPlayerPos",
        LevelEventClientSetPlayerPos_1.LevelEventClientSetPlayerPos,
      ),
      ...
      e(
        "ChangeEntityState",
        LevelEventChangeEntityState_1.LevelEventChangeEntityState,
      ),
      e(
        "ChangeSelfEntityState",
        LevelEventChangeSelfEntityState_1.LevelEventChangeSelfEntityState,
      ),
      e(
      ...
      e(
        LevelGameplayActionsDefine_1.ActionInteractGravityFlip.name,
        LevelEventInteractGravityFlip_1.LevelEventInteractGravityFlip,
      ),
      ...
      e(
        "VehicleEnterNpc",
        LevelEventEnterVehicleNpc_1.LevelEventEnterVehicleNpc,
      ),
      e(
        "VehicleWaterfallClimbing",
        LevelEventVehicleWaterfallMove_1.LevelEventVehicleWaterfallMove,
        LEVEL_1,
      ),
      e(
        "VehiclePlayPassengerVoice",
        LevelEventVehiclePlayPassengerVoice_1.LevelEventVehiclePlayPassengerVoice,
      ),
      e(
        "VehicleMoveWithPathLine",
        LevelEventVehicleMoveWithPathLine_1.LevelEventVehicleMoveWithPathLine,
      ),

...
class LevelAiTaskLog extends LevelAiTask_1.LevelAiTask {
  ExecuteTask() {
    ...
    if (e)
      switch (e.Level) {
        case "Warn":
          Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelAi", 29, e.Content);
          break;
        case "Info":
          Log_1.Log.CheckInfo() && Log_1.Log.Info("LevelAi", 29, e.Content);
          break;
        case "Error":
          Log_1.Log.CheckError() && Log_1.Log.Error("LevelAi", 29, e.Content);
      }
    return 0;
  }
}
